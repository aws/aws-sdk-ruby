  ...
  describe ParamValidator do
    ...
    describe 'floats' do
      ...
      it 'accepts integers' do
        ...
        validate({ float: 123 },
          [/expected params\[:float\] to be a Float, got value 123 \(class: (Integer|Fixnum)\) instead./])
      end
    ...
    describe 'blobs' do
      ...
      it 'accepts strings and io objects for payload members' do
        ...
        validate({ blob: 'abc' })
        validate({ blob: 123 },
          [/expected params\[:blob\] to be a String or IO object, got value 123 \(class: (Integer|Fixnum)\) instead./])
      end
    ...
    describe 'strings' do
      ...
      it 'accepts string objects' do
        ...
        validate({ string: 123 },
          [/expected params\[:string\] to be a String, got value 123 \(class: (Integer|Fixnum)\) instead./])
      end
