...
* Feature - Aws::WorkMail - Updated the documentation for Amazon WorkMail.
...
* Feature - Aws::Lambda - Updated the API, and waiters for AWS Lambda.
...
* Feature - Aws::ECS - Updated the API, documentation, and integration test for Amazon EC2 Container Service.
...
* Feature - Aws::Backup - Added support for a new service, AWS Backup.
...
* Feature - Aws::IoT - Updated the API, documentation, and integration test for AWS IoT.

* Feature - Aws::Lambda - Updated the API, and documentation for AWS Lambda.

* Feature - Aws::Lightsail - Updated the API for Amazon Lightsail.
...
* Feature - Aws::SQS - Updated the API, documentation, and integration test for Amazon Simple Queue Service.
...
* Feature - Aws::DirectoryService - Updated the API, documentation, and integration test for AWS Directory Service.
...
* Feature - Aws::ElastiCache - Updated the API, documentation, and integration test for Amazon ElastiCache.

* Feature - Aws::ElasticTranscoder - Updated the API, documentation, and integration test for Amazon Elastic Transcoder.
...
* Feature - Aws::ElasticLoadBalancing - Updated the API, documentation, and integration test for Elastic Load Balancing.
...
* Feature - Aws::ApplicationDiscoveryService - Updated the API, documentation, and integration test for AWS Application Discovery Service.
...
* Feature - Aws::CloudWatchLogs - Updated the API, documentation, and integration test for Amazon CloudWatch Logs.
...
* Feature - Aws::Inspector - Updated the API, documentation, and integration test for Amazon Inspector.
...
* Feature - Aws::ElasticLoadBalancingV2 - Updated the API, documentation, and integration test for Elastic Load Balancing.
...
* Feature - Aws::CodeBuild - Updated the API, documentation, and integration test for AWS CodeBuild.

* Feature - Aws::EC2 - Updated the API, and documentation for Amazon Elastic Compute Cloud.

* Feature - Aws::Glue - Updated the API, and documentation for AWS Glue.

* Feature - Aws::OpsWorks - Updated the documentation, and integration test for AWS OpsWorks.
...
* Feature - Aws::DeviceFarm - Updated the API, documentation, and integration test for AWS Device Farm.
...
* Feature - Aws::ServerlessApplicationRepository - Updated the documentation for AWSServerlessApplicationRepository.
...
* Feature - Aws::Mobile - Added support for a new service, AWS Mobile.
