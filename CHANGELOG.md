...
* Feature - Added Multipart Download Helper feature to support different mode(:auto, :single_request, :get_range) in downloading large objects with `#download_file` in multipart when possible.
