...
* Feature - Aws::AutoScaling - Updated the API for Auto Scaling.

* Feature - Aws::Budgets - Updated the API for AWS Budgets.

* Feature - Aws::{"ACM"=>{"models"=>"acm/2015-12-08", "endpoint"=>"acm"}, "APIGateway"=>{"models"=>"apigateway/2015-07-09", "endpoint"=>"apigateway"}, "ApplicationAutoScaling"=>{"models"=>"application-autoscaling/2016-02-06", "endpoint"=>"application-autoscaling"}, "ApplicationDiscoveryService"=>{"models"=>"discovery/2015-11-01", "endpoint"=>"discovery"}, "AppStream"=>{"models"=>"appstream/2016-12-01", "endpoint"=>"appstream2"}, "AutoScaling"=>{"models"=>"autoscaling/2011-01-01", "endpoint"=>"autoscaling"}, "Budgets"=>{"models"=>"budgets/2016-10-20", "endpoint"=>"budgets"}, "CodeBuild"=>{"models"=>"codebuild/2016-10-06", "endpoint"=>"codebuild"}, "CloudFormation"=>{"models"=>"cloudformation/2010-05-15", "endpoint"=>"cloudformation"}, "CloudFront"=>{"models"=>"cloudfront/2016-11-25", "endpoint"=>"cloudfront"}, "CloudHSM"=>{"models"=>"cloudhsm/2014-05-30", "endpoint"=>"cloudhsm"}, "CloudSearch"=>{"models"=>"cloudsearch/2013-01-01", "endpoint"=>"cloudsearch"}, "CloudSearchDomain"=>{"models"=>"cloudsearchdomain/2013-01-01"}, "CloudTrail"=>{"models"=>"cloudtrail/2013-11-01", "endpoint"=>"cloudtrail"}, "CloudWatch"=>{"models"=>"monitoring/2010-08-01", "endpoint"=>"monitoring"}, "CloudWatchEvents"=>{"models"=>"events/2015-10-07", "endpoint"=>"events"}, "CloudWatchLogs"=>{"models"=>"logs/2014-03-28", "endpoint"=>"logs"}, "CodeCommit"=>{"models"=>"codecommit/2015-04-13", "endpoint"=>"codecommit"}, "CodeDeploy"=>{"models"=>"codedeploy/2014-10-06", "endpoint"=>"codedeploy"}, "CodePipeline"=>{"models"=>"codepipeline/2015-07-09", "endpoint"=>"codepipeline"}, "CognitoIdentity"=>{"models"=>"cognito-identity/2014-06-30", "endpoint"=>"cognito-identity"}, "CognitoIdentityProvider"=>{"models"=>"cognito-idp/2016-04-18", "endpoint"=>"cognito-idp"}, "CognitoSync"=>{"models"=>"cognito-sync/2014-06-30", "endpoint"=>"cognito-sync"}, "ConfigService"=>{"models"=>"config/2014-11-12", "endpoint"=>"config"}, "DatabaseMigrationService"=>{"models"=>"dms/2016-01-01", "endpoint"=>"dms"}, "DataPipeline"=>{"models"=>"datapipeline/2012-10-29", "endpoint"=>"datapipeline"}, "DeviceFarm"=>{"models"=>"devicefarm/2015-06-23", "endpoint"=>"devicefarm"}, "DirectConnect"=>{"models"=>"directconnect/2012-10-25", "endpoint"=>"directconnect"}, "DirectoryService"=>{"models"=>"ds/2015-04-16", "endpoint"=>"ds"}, "DynamoDB"=>{"models"=>"dynamodb/2012-08-10", "endpoint"=>"dynamodb"}, "DynamoDBStreams"=>{"models"=>"streams.dynamodb/2012-08-10", "endpoint"=>"streams.dynamodb"}, "EC2"=>{"models"=>"ec2/2016-11-15", "endpoint"=>"ec2"}, "ECR"=>{"models"=>"ecr/2015-09-21", "endpoint"=>"ecr"}, "ECS"=>{"models"=>"ecs/2014-11-13", "endpoint"=>"ecs"}, "EFS"=>{"models"=>"elasticfilesystem/2015-02-01", "endpoint"=>"elasticfilesystem"}, "ElastiCache"=>{"models"=>"elasticache/2015-02-02", "endpoint"=>"elasticache"}, "ElasticBeanstalk"=>{"models"=>"elasticbeanstalk/2010-12-01", "endpoint"=>"elasticbeanstalk"}, "ElasticLoadBalancing"=>{"models"=>"elasticloadbalancing/2012-06-01", "endpoint"=>"elasticloadbalancing"}, "ElasticLoadBalancingV2"=>{"models"=>"elasticloadbalancingv2/2015-12-01", "endpoint"=>"elasticloadbalancing"}, "ElasticsearchService"=>{"models"=>"es/2015-01-01", "endpoint"=>"es"}, "ElasticTranscoder"=>{"models"=>"elastictranscoder/2012-09-25", "endpoint"=>"elastictranscoder"}, "EMR"=>{"models"=>"elasticmapreduce/2009-03-31", "endpoint"=>"elasticmapreduce"}, "Firehose"=>{"models"=>"firehose/2015-08-04", "endpoint"=>"firehose"}, "GameLift"=>{"models"=>"gamelift/2015-10-01", "endpoint"=>"gamelift"}, "Glacier"=>{"models"=>"glacier/2012-06-01", "endpoint"=>"glacier"}, "Health"=>{"models"=>"health/2016-08-04", "endpoint"=>"health"}, "IAM"=>{"models"=>"iam/2010-05-08", "endpoint"=>"iam"}, "ImportExport"=>{"models"=>"importexport/2010-06-01", "endpoint"=>"importexport"}, "Inspector"=>{"models"=>"inspector/2016-02-16", "endpoint"=>"inspector"}, "IoT"=>{"models"=>"iot/2015-05-28", "endpoint"=>"iot"}, "IoTDataPlane"=>{"models"=>"iot-data/2015-05-28", "endpoint"=>"data.iot"}, "Kinesis"=>{"models"=>"kinesis/2013-12-02", "endpoint"=>"kinesis"}, "KinesisAnalytics"=>{"models"=>"kinesisanalytics/2015-08-14", "endpoint"=>"kinesisanalytics"}, "KMS"=>{"models"=>"kms/2014-11-01", "endpoint"=>"kms"}, "Lambda"=>{"models"=>"lambda/2015-03-31", "endpoint"=>"lambda"}, "LambdaPreview"=>{"models"=>"lambda/2014-11-11", "endpoint"=>"lambda"}, "Lightsail"=>{"models"=>"lightsail/2016-11-28", "endpoint"=>"lightsail"}, "MachineLearning"=>{"models"=>"machinelearning/2014-12-12", "endpoint"=>"machinelearning"}, "MarketplaceCommerceAnalytics"=>{"models"=>"marketplacecommerceanalytics/2015-07-01", "endpoint"=>"marketplacecommerceanalytics"}, "MarketplaceMetering"=>{"models"=>"meteringmarketplace/2016-01-14", "endpoint"=>"metering.marketplace"}, "OpsWorks"=>{"models"=>"opsworks/2013-02-18", "endpoint"=>"opsworks"}, "OpsWorksCM"=>{"models"=>"opsworkscm/2016-11-01", "endpoint"=>"opsworks-cm"}, "Pinpoint"=>{"models"=>"pinpoint/2016-12-01", "endpoint"=>"pinpoint"}, "Polly"=>{"models"=>"polly/2016-06-10", "endpoint"=>"polly"}, "RDS"=>{"models"=>"rds/2014-10-31", "endpoint"=>"rds"}, "Rekognition"=>{"models"=>"rekognition/2016-06-27", "endpoint"=>"rekognition"}, "Redshift"=>{"models"=>"redshift/2012-12-01", "endpoint"=>"redshift"}, "Route53"=>{"models"=>"route53/2013-04-01", "endpoint"=>"route53"}, "Route53Domains"=>{"models"=>"route53domains/2014-05-15", "endpoint"=>"route53domains"}, "S3"=>{"models"=>"s3/2006-03-01", "endpoint"=>"s3"}, "ServiceCatalog"=>{"models"=>"servicecatalog/2015-12-10", "endpoint"=>"servicecatalog"}, "SES"=>{"models"=>"email/2010-12-01", "endpoint"=>"email"}, "Shield"=>{"models"=>"shield/2016-06-02", "endpoint"=>"shield"}, "SimpleDB"=>{"models"=>"sdb/2009-04-15", "endpoint"=>"sdb"}, "SMS"=>{"models"=>"sms/2016-10-24", "endpoint"=>"sms"}, "SNS"=>{"models"=>"sns/2010-03-31", "endpoint"=>"sns"}, "Snowball"=>{"models"=>"snowball/2016-06-30", "endpoint"=>"snowball"}, "SQS"=>{"models"=>"sqs/2012-11-05", "endpoint"=>"sqs"}, "SSM"=>{"models"=>"ssm/2014-11-06", "endpoint"=>"ssm"}, "States"=>{"models"=>"states/2016-11-23", "endpoint"=>"states"}, "StorageGateway"=>{"models"=>"storagegateway/2013-06-30", "endpoint"=>"storagegateway"}, "STS"=>{"models"=>"sts/2011-06-15", "endpoint"=>"sts"}, "Support"=>{"models"=>"support/2013-04-15", "endpoint"=>"support"}, "SWF"=>{"models"=>"swf/2012-01-25", "endpoint"=>"swf"}, "WAF"=>{"models"=>"waf/2015-08-24", "endpoint"=>"waf"}, "WAFRegional"=>{"models"=>"waf-regional/2016-11-28", "endpoint"=>"waf-regional"}, "WorkSpaces"=>{"models"=>"workspaces/2015-04-08", "endpoint"=>"workspaces"}, "XRay"=>{"models"=>"xray/2016-04-12", "endpoint"=>"xray"}} - Updated the API for Amazon CloudFront.
...
* Feature - Aws::CloudHSM - Updated the API for Amazon CloudHSM.

* Feature - Aws::CloudSearch - Updated the API for Amazon CloudSearch.

* Feature - Aws::CloudSearchDomain - Updated the API for Amazon CloudSearch Domain.

* Feature - Aws::CloudTrail - Updated the API for AWS CloudTrail.
...
* Feature - Aws::CognitoIdentity - Updated the API for Amazon Cognito Identity.

* Feature - Aws::CognitoIdentityProvider - Updated the API for Amazon Cognito Identity Provider.

* Feature - Aws::CognitoSync - Updated the API for Amazon Cognito Sync.

* Feature - Aws::DataPipeline - Updated the API for AWS Data Pipeline.

* Feature - Aws::DeviceFarm - Updated the API for AWS Device Farm.

* Feature - Aws::DirectConnect - Updated the API for AWS Direct Connect.

* Feature - Aws::ApplicationDiscoveryService - Updated the API for AWS Application Discovery Service.

* Feature - Aws::DatabaseMigrationService - Updated the API for AWS Database Migration Service.

* Feature - Aws::DirectoryService - Updated the API for AWS Directory Service.

* Feature - Aws::DynamoDB - Updated the API for Amazon DynamoDB.
...
* Feature - Aws::ECS - Updated the API for Amazon EC2 Container Service.

* Feature - Aws::ElastiCache - Updated the API for Amazon ElastiCache.

* Feature - Aws::EFS - Updated the API for Amazon Elastic File System.

* Feature - Aws::ElasticLoadBalancing - Updated the API for Elastic Load Balancing.

* Feature - Aws::ElasticLoadBalancingV2 - Updated the API for Elastic Load Balancing.

* Feature - Aws::EMR - Updated the API for Amazon Elastic MapReduce.

* Feature - Aws::ElasticTranscoder - Updated the API for Amazon Elastic Transcoder.

* Feature - Aws::SES - Updated the API for Amazon Simple Email Service.

* Feature - Aws::ElasticsearchService - Updated the API for Amazon Elasticsearch Service.

* Feature - Aws::CloudWatchEvents - Updated the API for Amazon CloudWatch Events.

* Feature - Aws::Firehose - Updated the API for Amazon Kinesis Firehose.

* Feature - Aws::GameLift - Updated the API for Amazon GameLift.

* Feature - Aws::Glacier - Updated the API for Amazon Glacier.

* Feature - Aws::IAM - Updated the API for AWS Identity and Access Management.

* Feature - Aws::ImportExport - Updated the API for AWS Import/Export.

* Feature - Aws::Inspector - Updated the API for Amazon Inspector.

* Feature - Aws::IoTDataPlane - Updated the API for AWS IoT Data Plane.

* Feature - Aws::IoT - Updated the API for AWS IoT.

* Feature - Aws::Kinesis - Updated the API for Amazon Kinesis.

* Feature - Aws::KinesisAnalytics - Updated the API for Amazon Kinesis Analytics.

* Feature - Aws::KMS - Updated the API for AWS Key Management Service.

* Feature - Aws::LambdaPreview - Updated the API for AWS Lambda.

* Feature - Aws::CloudWatchLogs - Updated the API for Amazon CloudWatch Logs.

* Feature - Aws::MachineLearning - Updated the API for Amazon Machine Learning.

* Feature - Aws::MarketplaceCommerceAnalytics - Updated the API for AWS Marketplace Commerce Analytics.

* Feature - Aws::MarketplaceMetering - Updated the API for AWSMarketplace Metering.

* Feature - Aws::CloudWatch - Updated the API for Amazon CloudWatch.

* Feature - Aws::OpsWorks - Updated the API for AWS OpsWorks.

* Feature - Aws::RDS - Updated the API, and documentation for Amazon Relational Database Service.

* Feature - Aws::Redshift - Updated the API for Amazon Redshift.

* Feature - Aws::Route53Domains - Updated the API for Amazon Route 53 Domains.

* Feature - Aws::SimpleDB - Updated the API for Amazon SimpleDB.

* Feature - Aws::ServiceCatalog - Updated the API for AWS Service Catalog.

* Feature - Aws::SMS - Updated the API for AWS Server Migration Service.

* Feature - Aws::SNS - Updated the API for Amazon Simple Notification Service.

* Feature - Aws::StorageGateway - Updated the API for AWS Storage Gateway.

* Feature - Aws::DynamoDBStreams - Updated the API for Amazon DynamoDB Streams.

* Feature - Aws::Support - Updated the API for AWS Support.

* Feature - Aws::SWF - Updated the API for Amazon Simple Workflow Service.
...
* Feature - Aws::{"ACM"=>{"models"=>"acm/2015-12-08", "endpoint"=>"acm"}, "APIGateway"=>{"models"=>"apigateway/2015-07-09", "endpoint"=>"apigateway"}, "ApplicationAutoScaling"=>{"models"=>"application-autoscaling/2016-02-06", "endpoint"=>"application-autoscaling"}, "ApplicationDiscoveryService"=>{"models"=>"discovery/2015-11-01", "endpoint"=>"discovery"}, "AppStream"=>{"models"=>"appstream/2016-12-01", "endpoint"=>"appstream2"}, "AutoScaling"=>{"models"=>"autoscaling/2011-01-01", "endpoint"=>"autoscaling"}, "Budgets"=>{"models"=>"budgets/2016-10-20", "endpoint"=>"budgets"}, "CodeBuild"=>{"models"=>"codebuild/2016-10-06", "endpoint"=>"codebuild"}, "CloudFormation"=>{"models"=>"cloudformation/2010-05-15", "endpoint"=>"cloudformation"}, "CloudFront"=>{"models"=>"cloudfront/2016-11-25", "endpoint"=>"cloudfront"}, "CloudHSM"=>{"models"=>"cloudhsm/2014-05-30", "endpoint"=>"cloudhsm"}, "CloudSearch"=>{"models"=>"cloudsearch/2013-01-01", "endpoint"=>"cloudsearch"}, "CloudSearchDomain"=>{"models"=>"cloudsearchdomain/2013-01-01"}, "CloudTrail"=>{"models"=>"cloudtrail/2013-11-01", "endpoint"=>"cloudtrail"}, "CloudWatch"=>{"models"=>"monitoring/2010-08-01", "endpoint"=>"monitoring"}, "CloudWatchEvents"=>{"models"=>"events/2015-10-07", "endpoint"=>"events"}, "CloudWatchLogs"=>{"models"=>"logs/2014-03-28", "endpoint"=>"logs"}, "CodeCommit"=>{"models"=>"codecommit/2015-04-13", "endpoint"=>"codecommit"}, "CodeDeploy"=>{"models"=>"codedeploy/2014-10-06", "endpoint"=>"codedeploy"}, "CodePipeline"=>{"models"=>"codepipeline/2015-07-09", "endpoint"=>"codepipeline"}, "CognitoIdentity"=>{"models"=>"cognito-identity/2014-06-30", "endpoint"=>"cognito-identity"}, "CognitoIdentityProvider"=>{"models"=>"cognito-idp/2016-04-18", "endpoint"=>"cognito-idp"}, "CognitoSync"=>{"models"=>"cognito-sync/2014-06-30", "endpoint"=>"cognito-sync"}, "ConfigService"=>{"models"=>"config/2014-11-12", "endpoint"=>"config"}, "DatabaseMigrationService"=>{"models"=>"dms/2016-01-01", "endpoint"=>"dms"}, "DataPipeline"=>{"models"=>"datapipeline/2012-10-29", "endpoint"=>"datapipeline"}, "DeviceFarm"=>{"models"=>"devicefarm/2015-06-23", "endpoint"=>"devicefarm"}, "DirectConnect"=>{"models"=>"directconnect/2012-10-25", "endpoint"=>"directconnect"}, "DirectoryService"=>{"models"=>"ds/2015-04-16", "endpoint"=>"ds"}, "DynamoDB"=>{"models"=>"dynamodb/2012-08-10", "endpoint"=>"dynamodb"}, "DynamoDBStreams"=>{"models"=>"streams.dynamodb/2012-08-10", "endpoint"=>"streams.dynamodb"}, "EC2"=>{"models"=>"ec2/2016-11-15", "endpoint"=>"ec2"}, "ECR"=>{"models"=>"ecr/2015-09-21", "endpoint"=>"ecr"}, "ECS"=>{"models"=>"ecs/2014-11-13", "endpoint"=>"ecs"}, "EFS"=>{"models"=>"elasticfilesystem/2015-02-01", "endpoint"=>"elasticfilesystem"}, "ElastiCache"=>{"models"=>"elasticache/2015-02-02", "endpoint"=>"elasticache"}, "ElasticBeanstalk"=>{"models"=>"elasticbeanstalk/2010-12-01", "endpoint"=>"elasticbeanstalk"}, "ElasticLoadBalancing"=>{"models"=>"elasticloadbalancing/2012-06-01", "endpoint"=>"elasticloadbalancing"}, "ElasticLoadBalancingV2"=>{"models"=>"elasticloadbalancingv2/2015-12-01", "endpoint"=>"elasticloadbalancing"}, "ElasticsearchService"=>{"models"=>"es/2015-01-01", "endpoint"=>"es"}, "ElasticTranscoder"=>{"models"=>"elastictranscoder/2012-09-25", "endpoint"=>"elastictranscoder"}, "EMR"=>{"models"=>"elasticmapreduce/2009-03-31", "endpoint"=>"elasticmapreduce"}, "Firehose"=>{"models"=>"firehose/2015-08-04", "endpoint"=>"firehose"}, "GameLift"=>{"models"=>"gamelift/2015-10-01", "endpoint"=>"gamelift"}, "Glacier"=>{"models"=>"glacier/2012-06-01", "endpoint"=>"glacier"}, "Health"=>{"models"=>"health/2016-08-04", "endpoint"=>"health"}, "IAM"=>{"models"=>"iam/2010-05-08", "endpoint"=>"iam"}, "ImportExport"=>{"models"=>"importexport/2010-06-01", "endpoint"=>"importexport"}, "Inspector"=>{"models"=>"inspector/2016-02-16", "endpoint"=>"inspector"}, "IoT"=>{"models"=>"iot/2015-05-28", "endpoint"=>"iot"}, "IoTDataPlane"=>{"models"=>"iot-data/2015-05-28", "endpoint"=>"data.iot"}, "Kinesis"=>{"models"=>"kinesis/2013-12-02", "endpoint"=>"kinesis"}, "KinesisAnalytics"=>{"models"=>"kinesisanalytics/2015-08-14", "endpoint"=>"kinesisanalytics"}, "KMS"=>{"models"=>"kms/2014-11-01", "endpoint"=>"kms"}, "Lambda"=>{"models"=>"lambda/2015-03-31", "endpoint"=>"lambda"}, "LambdaPreview"=>{"models"=>"lambda/2014-11-11", "endpoint"=>"lambda"}, "Lightsail"=>{"models"=>"lightsail/2016-11-28", "endpoint"=>"lightsail"}, "MachineLearning"=>{"models"=>"machinelearning/2014-12-12", "endpoint"=>"machinelearning"}, "MarketplaceCommerceAnalytics"=>{"models"=>"marketplacecommerceanalytics/2015-07-01", "endpoint"=>"marketplacecommerceanalytics"}, "MarketplaceMetering"=>{"models"=>"meteringmarketplace/2016-01-14", "endpoint"=>"metering.marketplace"}, "OpsWorks"=>{"models"=>"opsworks/2013-02-18", "endpoint"=>"opsworks"}, "OpsWorksCM"=>{"models"=>"opsworkscm/2016-11-01", "endpoint"=>"opsworks-cm"}, "Pinpoint"=>{"models"=>"pinpoint/2016-12-01", "endpoint"=>"pinpoint"}, "Polly"=>{"models"=>"polly/2016-06-10", "endpoint"=>"polly"}, "RDS"=>{"models"=>"rds/2014-10-31", "endpoint"=>"rds"}, "Rekognition"=>{"models"=>"rekognition/2016-06-27", "endpoint"=>"rekognition"}, "Redshift"=>{"models"=>"redshift/2012-12-01", "endpoint"=>"redshift"}, "Route53"=>{"models"=>"route53/2013-04-01", "endpoint"=>"route53"}, "Route53Domains"=>{"models"=>"route53domains/2014-05-15", "endpoint"=>"route53domains"}, "S3"=>{"models"=>"s3/2006-03-01", "endpoint"=>"s3"}, "ServiceCatalog"=>{"models"=>"servicecatalog/2015-12-10", "endpoint"=>"servicecatalog"}, "SES"=>{"models"=>"email/2010-12-01", "endpoint"=>"email"}, "Shield"=>{"models"=>"shield/2016-06-02", "endpoint"=>"shield"}, "SimpleDB"=>{"models"=>"sdb/2009-04-15", "endpoint"=>"sdb"}, "SMS"=>{"models"=>"sms/2016-10-24", "endpoint"=>"sms"}, "SNS"=>{"models"=>"sns/2010-03-31", "endpoint"=>"sns"}, "Snowball"=>{"models"=>"snowball/2016-06-30", "endpoint"=>"snowball"}, "SQS"=>{"models"=>"sqs/2012-11-05", "endpoint"=>"sqs"}, "SSM"=>{"models"=>"ssm/2014-11-06", "endpoint"=>"ssm"}, "States"=>{"models"=>"states/2016-11-23", "endpoint"=>"states"}, "StorageGateway"=>{"models"=>"storagegateway/2013-06-30", "endpoint"=>"storagegateway"}, "STS"=>{"models"=>"sts/2011-06-15", "endpoint"=>"sts"}, "Support"=>{"models"=>"support/2013-04-15", "endpoint"=>"support"}, "SWF"=>{"models"=>"swf/2012-01-25", "endpoint"=>"swf"}, "WAF"=>{"models"=>"waf/2015-08-24", "endpoint"=>"waf"}, "WAFRegional"=>{"models"=>"waf-regional/2016-11-28", "endpoint"=>"waf-regional"}, "WorkSpaces"=>{"models"=>"workspaces/2015-04-08", "endpoint"=>"workspaces"}, "XRay"=>{"models"=>"xray/2016-04-12", "endpoint"=>"xray"}} - Added support for the new 2013-01-10 API version of Amazon Relational Database Service.

* Feature - Aws::{"ACM"=>{"models"=>"acm/2015-12-08", "endpoint"=>"acm"}, "APIGateway"=>{"models"=>"apigateway/2015-07-09", "endpoint"=>"apigateway"}, "ApplicationAutoScaling"=>{"models"=>"application-autoscaling/2016-02-06", "endpoint"=>"application-autoscaling"}, "ApplicationDiscoveryService"=>{"models"=>"discovery/2015-11-01", "endpoint"=>"discovery"}, "AppStream"=>{"models"=>"appstream/2016-12-01", "endpoint"=>"appstream2"}, "AutoScaling"=>{"models"=>"autoscaling/2011-01-01", "endpoint"=>"autoscaling"}, "Budgets"=>{"models"=>"budgets/2016-10-20", "endpoint"=>"budgets"}, "CodeBuild"=>{"models"=>"codebuild/2016-10-06", "endpoint"=>"codebuild"}, "CloudFormation"=>{"models"=>"cloudformation/2010-05-15", "endpoint"=>"cloudformation"}, "CloudFront"=>{"models"=>"cloudfront/2016-11-25", "endpoint"=>"cloudfront"}, "CloudHSM"=>{"models"=>"cloudhsm/2014-05-30", "endpoint"=>"cloudhsm"}, "CloudSearch"=>{"models"=>"cloudsearch/2013-01-01", "endpoint"=>"cloudsearch"}, "CloudSearchDomain"=>{"models"=>"cloudsearchdomain/2013-01-01"}, "CloudTrail"=>{"models"=>"cloudtrail/2013-11-01", "endpoint"=>"cloudtrail"}, "CloudWatch"=>{"models"=>"monitoring/2010-08-01", "endpoint"=>"monitoring"}, "CloudWatchEvents"=>{"models"=>"events/2015-10-07", "endpoint"=>"events"}, "CloudWatchLogs"=>{"models"=>"logs/2014-03-28", "endpoint"=>"logs"}, "CodeCommit"=>{"models"=>"codecommit/2015-04-13", "endpoint"=>"codecommit"}, "CodeDeploy"=>{"models"=>"codedeploy/2014-10-06", "endpoint"=>"codedeploy"}, "CodePipeline"=>{"models"=>"codepipeline/2015-07-09", "endpoint"=>"codepipeline"}, "CognitoIdentity"=>{"models"=>"cognito-identity/2014-06-30", "endpoint"=>"cognito-identity"}, "CognitoIdentityProvider"=>{"models"=>"cognito-idp/2016-04-18", "endpoint"=>"cognito-idp"}, "CognitoSync"=>{"models"=>"cognito-sync/2014-06-30", "endpoint"=>"cognito-sync"}, "ConfigService"=>{"models"=>"config/2014-11-12", "endpoint"=>"config"}, "DatabaseMigrationService"=>{"models"=>"dms/2016-01-01", "endpoint"=>"dms"}, "DataPipeline"=>{"models"=>"datapipeline/2012-10-29", "endpoint"=>"datapipeline"}, "DeviceFarm"=>{"models"=>"devicefarm/2015-06-23", "endpoint"=>"devicefarm"}, "DirectConnect"=>{"models"=>"directconnect/2012-10-25", "endpoint"=>"directconnect"}, "DirectoryService"=>{"models"=>"ds/2015-04-16", "endpoint"=>"ds"}, "DynamoDB"=>{"models"=>"dynamodb/2012-08-10", "endpoint"=>"dynamodb"}, "DynamoDBStreams"=>{"models"=>"streams.dynamodb/2012-08-10", "endpoint"=>"streams.dynamodb"}, "EC2"=>{"models"=>"ec2/2016-11-15", "endpoint"=>"ec2"}, "ECR"=>{"models"=>"ecr/2015-09-21", "endpoint"=>"ecr"}, "ECS"=>{"models"=>"ecs/2014-11-13", "endpoint"=>"ecs"}, "EFS"=>{"models"=>"elasticfilesystem/2015-02-01", "endpoint"=>"elasticfilesystem"}, "ElastiCache"=>{"models"=>"elasticache/2015-02-02", "endpoint"=>"elasticache"}, "ElasticBeanstalk"=>{"models"=>"elasticbeanstalk/2010-12-01", "endpoint"=>"elasticbeanstalk"}, "ElasticLoadBalancing"=>{"models"=>"elasticloadbalancing/2012-06-01", "endpoint"=>"elasticloadbalancing"}, "ElasticLoadBalancingV2"=>{"models"=>"elasticloadbalancingv2/2015-12-01", "endpoint"=>"elasticloadbalancing"}, "ElasticsearchService"=>{"models"=>"es/2015-01-01", "endpoint"=>"es"}, "ElasticTranscoder"=>{"models"=>"elastictranscoder/2012-09-25", "endpoint"=>"elastictranscoder"}, "EMR"=>{"models"=>"elasticmapreduce/2009-03-31", "endpoint"=>"elasticmapreduce"}, "Firehose"=>{"models"=>"firehose/2015-08-04", "endpoint"=>"firehose"}, "GameLift"=>{"models"=>"gamelift/2015-10-01", "endpoint"=>"gamelift"}, "Glacier"=>{"models"=>"glacier/2012-06-01", "endpoint"=>"glacier"}, "Health"=>{"models"=>"health/2016-08-04", "endpoint"=>"health"}, "IAM"=>{"models"=>"iam/2010-05-08", "endpoint"=>"iam"}, "ImportExport"=>{"models"=>"importexport/2010-06-01", "endpoint"=>"importexport"}, "Inspector"=>{"models"=>"inspector/2016-02-16", "endpoint"=>"inspector"}, "IoT"=>{"models"=>"iot/2015-05-28", "endpoint"=>"iot"}, "IoTDataPlane"=>{"models"=>"iot-data/2015-05-28", "endpoint"=>"data.iot"}, "Kinesis"=>{"models"=>"kinesis/2013-12-02", "endpoint"=>"kinesis"}, "KinesisAnalytics"=>{"models"=>"kinesisanalytics/2015-08-14", "endpoint"=>"kinesisanalytics"}, "KMS"=>{"models"=>"kms/2014-11-01", "endpoint"=>"kms"}, "Lambda"=>{"models"=>"lambda/2015-03-31", "endpoint"=>"lambda"}, "LambdaPreview"=>{"models"=>"lambda/2014-11-11", "endpoint"=>"lambda"}, "Lightsail"=>{"models"=>"lightsail/2016-11-28", "endpoint"=>"lightsail"}, "MachineLearning"=>{"models"=>"machinelearning/2014-12-12", "endpoint"=>"machinelearning"}, "MarketplaceCommerceAnalytics"=>{"models"=>"marketplacecommerceanalytics/2015-07-01", "endpoint"=>"marketplacecommerceanalytics"}, "MarketplaceMetering"=>{"models"=>"meteringmarketplace/2016-01-14", "endpoint"=>"metering.marketplace"}, "OpsWorks"=>{"models"=>"opsworks/2013-02-18", "endpoint"=>"opsworks"}, "OpsWorksCM"=>{"models"=>"opsworkscm/2016-11-01", "endpoint"=>"opsworks-cm"}, "Pinpoint"=>{"models"=>"pinpoint/2016-12-01", "endpoint"=>"pinpoint"}, "Polly"=>{"models"=>"polly/2016-06-10", "endpoint"=>"polly"}, "RDS"=>{"models"=>"rds/2014-10-31", "endpoint"=>"rds"}, "Rekognition"=>{"models"=>"rekognition/2016-06-27", "endpoint"=>"rekognition"}, "Redshift"=>{"models"=>"redshift/2012-12-01", "endpoint"=>"redshift"}, "Route53"=>{"models"=>"route53/2013-04-01", "endpoint"=>"route53"}, "Route53Domains"=>{"models"=>"route53domains/2014-05-15", "endpoint"=>"route53domains"}, "S3"=>{"models"=>"s3/2006-03-01", "endpoint"=>"s3"}, "ServiceCatalog"=>{"models"=>"servicecatalog/2015-12-10", "endpoint"=>"servicecatalog"}, "SES"=>{"models"=>"email/2010-12-01", "endpoint"=>"email"}, "Shield"=>{"models"=>"shield/2016-06-02", "endpoint"=>"shield"}, "SimpleDB"=>{"models"=>"sdb/2009-04-15", "endpoint"=>"sdb"}, "SMS"=>{"models"=>"sms/2016-10-24", "endpoint"=>"sms"}, "SNS"=>{"models"=>"sns/2010-03-31", "endpoint"=>"sns"}, "Snowball"=>{"models"=>"snowball/2016-06-30", "endpoint"=>"snowball"}, "SQS"=>{"models"=>"sqs/2012-11-05", "endpoint"=>"sqs"}, "SSM"=>{"models"=>"ssm/2014-11-06", "endpoint"=>"ssm"}, "States"=>{"models"=>"states/2016-11-23", "endpoint"=>"states"}, "StorageGateway"=>{"models"=>"storagegateway/2013-06-30", "endpoint"=>"storagegateway"}, "STS"=>{"models"=>"sts/2011-06-15", "endpoint"=>"sts"}, "Support"=>{"models"=>"support/2013-04-15", "endpoint"=>"support"}, "SWF"=>{"models"=>"swf/2012-01-25", "endpoint"=>"swf"}, "WAF"=>{"models"=>"waf/2015-08-24", "endpoint"=>"waf"}, "WAFRegional"=>{"models"=>"waf-regional/2016-11-28", "endpoint"=>"waf-regional"}, "WorkSpaces"=>{"models"=>"workspaces/2015-04-08", "endpoint"=>"workspaces"}, "XRay"=>{"models"=>"xray/2016-04-12", "endpoint"=>"xray"}} - Added support for the new 2013-02-12 API version of Amazon Relational Database Service.

* Feature - Aws::{"ACM"=>{"models"=>"acm/2015-12-08", "endpoint"=>"acm"}, "APIGateway"=>{"models"=>"apigateway/2015-07-09", "endpoint"=>"apigateway"}, "ApplicationAutoScaling"=>{"models"=>"application-autoscaling/2016-02-06", "endpoint"=>"application-autoscaling"}, "ApplicationDiscoveryService"=>{"models"=>"discovery/2015-11-01", "endpoint"=>"discovery"}, "AppStream"=>{"models"=>"appstream/2016-12-01", "endpoint"=>"appstream2"}, "AutoScaling"=>{"models"=>"autoscaling/2011-01-01", "endpoint"=>"autoscaling"}, "Budgets"=>{"models"=>"budgets/2016-10-20", "endpoint"=>"budgets"}, "CodeBuild"=>{"models"=>"codebuild/2016-10-06", "endpoint"=>"codebuild"}, "CloudFormation"=>{"models"=>"cloudformation/2010-05-15", "endpoint"=>"cloudformation"}, "CloudFront"=>{"models"=>"cloudfront/2016-11-25", "endpoint"=>"cloudfront"}, "CloudHSM"=>{"models"=>"cloudhsm/2014-05-30", "endpoint"=>"cloudhsm"}, "CloudSearch"=>{"models"=>"cloudsearch/2013-01-01", "endpoint"=>"cloudsearch"}, "CloudSearchDomain"=>{"models"=>"cloudsearchdomain/2013-01-01"}, "CloudTrail"=>{"models"=>"cloudtrail/2013-11-01", "endpoint"=>"cloudtrail"}, "CloudWatch"=>{"models"=>"monitoring/2010-08-01", "endpoint"=>"monitoring"}, "CloudWatchEvents"=>{"models"=>"events/2015-10-07", "endpoint"=>"events"}, "CloudWatchLogs"=>{"models"=>"logs/2014-03-28", "endpoint"=>"logs"}, "CodeCommit"=>{"models"=>"codecommit/2015-04-13", "endpoint"=>"codecommit"}, "CodeDeploy"=>{"models"=>"codedeploy/2014-10-06", "endpoint"=>"codedeploy"}, "CodePipeline"=>{"models"=>"codepipeline/2015-07-09", "endpoint"=>"codepipeline"}, "CognitoIdentity"=>{"models"=>"cognito-identity/2014-06-30", "endpoint"=>"cognito-identity"}, "CognitoIdentityProvider"=>{"models"=>"cognito-idp/2016-04-18", "endpoint"=>"cognito-idp"}, "CognitoSync"=>{"models"=>"cognito-sync/2014-06-30", "endpoint"=>"cognito-sync"}, "ConfigService"=>{"models"=>"config/2014-11-12", "endpoint"=>"config"}, "DatabaseMigrationService"=>{"models"=>"dms/2016-01-01", "endpoint"=>"dms"}, "DataPipeline"=>{"models"=>"datapipeline/2012-10-29", "endpoint"=>"datapipeline"}, "DeviceFarm"=>{"models"=>"devicefarm/2015-06-23", "endpoint"=>"devicefarm"}, "DirectConnect"=>{"models"=>"directconnect/2012-10-25", "endpoint"=>"directconnect"}, "DirectoryService"=>{"models"=>"ds/2015-04-16", "endpoint"=>"ds"}, "DynamoDB"=>{"models"=>"dynamodb/2012-08-10", "endpoint"=>"dynamodb"}, "DynamoDBStreams"=>{"models"=>"streams.dynamodb/2012-08-10", "endpoint"=>"streams.dynamodb"}, "EC2"=>{"models"=>"ec2/2016-11-15", "endpoint"=>"ec2"}, "ECR"=>{"models"=>"ecr/2015-09-21", "endpoint"=>"ecr"}, "ECS"=>{"models"=>"ecs/2014-11-13", "endpoint"=>"ecs"}, "EFS"=>{"models"=>"elasticfilesystem/2015-02-01", "endpoint"=>"elasticfilesystem"}, "ElastiCache"=>{"models"=>"elasticache/2015-02-02", "endpoint"=>"elasticache"}, "ElasticBeanstalk"=>{"models"=>"elasticbeanstalk/2010-12-01", "endpoint"=>"elasticbeanstalk"}, "ElasticLoadBalancing"=>{"models"=>"elasticloadbalancing/2012-06-01", "endpoint"=>"elasticloadbalancing"}, "ElasticLoadBalancingV2"=>{"models"=>"elasticloadbalancingv2/2015-12-01", "endpoint"=>"elasticloadbalancing"}, "ElasticsearchService"=>{"models"=>"es/2015-01-01", "endpoint"=>"es"}, "ElasticTranscoder"=>{"models"=>"elastictranscoder/2012-09-25", "endpoint"=>"elastictranscoder"}, "EMR"=>{"models"=>"elasticmapreduce/2009-03-31", "endpoint"=>"elasticmapreduce"}, "Firehose"=>{"models"=>"firehose/2015-08-04", "endpoint"=>"firehose"}, "GameLift"=>{"models"=>"gamelift/2015-10-01", "endpoint"=>"gamelift"}, "Glacier"=>{"models"=>"glacier/2012-06-01", "endpoint"=>"glacier"}, "Health"=>{"models"=>"health/2016-08-04", "endpoint"=>"health"}, "IAM"=>{"models"=>"iam/2010-05-08", "endpoint"=>"iam"}, "ImportExport"=>{"models"=>"importexport/2010-06-01", "endpoint"=>"importexport"}, "Inspector"=>{"models"=>"inspector/2016-02-16", "endpoint"=>"inspector"}, "IoT"=>{"models"=>"iot/2015-05-28", "endpoint"=>"iot"}, "IoTDataPlane"=>{"models"=>"iot-data/2015-05-28", "endpoint"=>"data.iot"}, "Kinesis"=>{"models"=>"kinesis/2013-12-02", "endpoint"=>"kinesis"}, "KinesisAnalytics"=>{"models"=>"kinesisanalytics/2015-08-14", "endpoint"=>"kinesisanalytics"}, "KMS"=>{"models"=>"kms/2014-11-01", "endpoint"=>"kms"}, "Lambda"=>{"models"=>"lambda/2015-03-31", "endpoint"=>"lambda"}, "LambdaPreview"=>{"models"=>"lambda/2014-11-11", "endpoint"=>"lambda"}, "Lightsail"=>{"models"=>"lightsail/2016-11-28", "endpoint"=>"lightsail"}, "MachineLearning"=>{"models"=>"machinelearning/2014-12-12", "endpoint"=>"machinelearning"}, "MarketplaceCommerceAnalytics"=>{"models"=>"marketplacecommerceanalytics/2015-07-01", "endpoint"=>"marketplacecommerceanalytics"}, "MarketplaceMetering"=>{"models"=>"meteringmarketplace/2016-01-14", "endpoint"=>"metering.marketplace"}, "OpsWorks"=>{"models"=>"opsworks/2013-02-18", "endpoint"=>"opsworks"}, "OpsWorksCM"=>{"models"=>"opsworkscm/2016-11-01", "endpoint"=>"opsworks-cm"}, "Pinpoint"=>{"models"=>"pinpoint/2016-12-01", "endpoint"=>"pinpoint"}, "Polly"=>{"models"=>"polly/2016-06-10", "endpoint"=>"polly"}, "RDS"=>{"models"=>"rds/2014-10-31", "endpoint"=>"rds"}, "Rekognition"=>{"models"=>"rekognition/2016-06-27", "endpoint"=>"rekognition"}, "Redshift"=>{"models"=>"redshift/2012-12-01", "endpoint"=>"redshift"}, "Route53"=>{"models"=>"route53/2013-04-01", "endpoint"=>"route53"}, "Route53Domains"=>{"models"=>"route53domains/2014-05-15", "endpoint"=>"route53domains"}, "S3"=>{"models"=>"s3/2006-03-01", "endpoint"=>"s3"}, "ServiceCatalog"=>{"models"=>"servicecatalog/2015-12-10", "endpoint"=>"servicecatalog"}, "SES"=>{"models"=>"email/2010-12-01", "endpoint"=>"email"}, "Shield"=>{"models"=>"shield/2016-06-02", "endpoint"=>"shield"}, "SimpleDB"=>{"models"=>"sdb/2009-04-15", "endpoint"=>"sdb"}, "SMS"=>{"models"=>"sms/2016-10-24", "endpoint"=>"sms"}, "SNS"=>{"models"=>"sns/2010-03-31", "endpoint"=>"sns"}, "Snowball"=>{"models"=>"snowball/2016-06-30", "endpoint"=>"snowball"}, "SQS"=>{"models"=>"sqs/2012-11-05", "endpoint"=>"sqs"}, "SSM"=>{"models"=>"ssm/2014-11-06", "endpoint"=>"ssm"}, "States"=>{"models"=>"states/2016-11-23", "endpoint"=>"states"}, "StorageGateway"=>{"models"=>"storagegateway/2013-06-30", "endpoint"=>"storagegateway"}, "STS"=>{"models"=>"sts/2011-06-15", "endpoint"=>"sts"}, "Support"=>{"models"=>"support/2013-04-15", "endpoint"=>"support"}, "SWF"=>{"models"=>"swf/2012-01-25", "endpoint"=>"swf"}, "WAF"=>{"models"=>"waf/2015-08-24", "endpoint"=>"waf"}, "WAFRegional"=>{"models"=>"waf-regional/2016-11-28", "endpoint"=>"waf-regional"}, "WorkSpaces"=>{"models"=>"workspaces/2015-04-08", "endpoint"=>"workspaces"}, "XRay"=>{"models"=>"xray/2016-04-12", "endpoint"=>"xray"}} - Added support for the new 2013-09-09 API version of Amazon Relational Database Service.

* Feature - Aws::{"ACM"=>{"models"=>"acm/2015-12-08", "endpoint"=>"acm"}, "APIGateway"=>{"models"=>"apigateway/2015-07-09", "endpoint"=>"apigateway"}, "ApplicationAutoScaling"=>{"models"=>"application-autoscaling/2016-02-06", "endpoint"=>"application-autoscaling"}, "ApplicationDiscoveryService"=>{"models"=>"discovery/2015-11-01", "endpoint"=>"discovery"}, "AppStream"=>{"models"=>"appstream/2016-12-01", "endpoint"=>"appstream2"}, "AutoScaling"=>{"models"=>"autoscaling/2011-01-01", "endpoint"=>"autoscaling"}, "Budgets"=>{"models"=>"budgets/2016-10-20", "endpoint"=>"budgets"}, "CodeBuild"=>{"models"=>"codebuild/2016-10-06", "endpoint"=>"codebuild"}, "CloudFormation"=>{"models"=>"cloudformation/2010-05-15", "endpoint"=>"cloudformation"}, "CloudFront"=>{"models"=>"cloudfront/2016-11-25", "endpoint"=>"cloudfront"}, "CloudHSM"=>{"models"=>"cloudhsm/2014-05-30", "endpoint"=>"cloudhsm"}, "CloudSearch"=>{"models"=>"cloudsearch/2013-01-01", "endpoint"=>"cloudsearch"}, "CloudSearchDomain"=>{"models"=>"cloudsearchdomain/2013-01-01"}, "CloudTrail"=>{"models"=>"cloudtrail/2013-11-01", "endpoint"=>"cloudtrail"}, "CloudWatch"=>{"models"=>"monitoring/2010-08-01", "endpoint"=>"monitoring"}, "CloudWatchEvents"=>{"models"=>"events/2015-10-07", "endpoint"=>"events"}, "CloudWatchLogs"=>{"models"=>"logs/2014-03-28", "endpoint"=>"logs"}, "CodeCommit"=>{"models"=>"codecommit/2015-04-13", "endpoint"=>"codecommit"}, "CodeDeploy"=>{"models"=>"codedeploy/2014-10-06", "endpoint"=>"codedeploy"}, "CodePipeline"=>{"models"=>"codepipeline/2015-07-09", "endpoint"=>"codepipeline"}, "CognitoIdentity"=>{"models"=>"cognito-identity/2014-06-30", "endpoint"=>"cognito-identity"}, "CognitoIdentityProvider"=>{"models"=>"cognito-idp/2016-04-18", "endpoint"=>"cognito-idp"}, "CognitoSync"=>{"models"=>"cognito-sync/2014-06-30", "endpoint"=>"cognito-sync"}, "ConfigService"=>{"models"=>"config/2014-11-12", "endpoint"=>"config"}, "DatabaseMigrationService"=>{"models"=>"dms/2016-01-01", "endpoint"=>"dms"}, "DataPipeline"=>{"models"=>"datapipeline/2012-10-29", "endpoint"=>"datapipeline"}, "DeviceFarm"=>{"models"=>"devicefarm/2015-06-23", "endpoint"=>"devicefarm"}, "DirectConnect"=>{"models"=>"directconnect/2012-10-25", "endpoint"=>"directconnect"}, "DirectoryService"=>{"models"=>"ds/2015-04-16", "endpoint"=>"ds"}, "DynamoDB"=>{"models"=>"dynamodb/2012-08-10", "endpoint"=>"dynamodb"}, "DynamoDBStreams"=>{"models"=>"streams.dynamodb/2012-08-10", "endpoint"=>"streams.dynamodb"}, "EC2"=>{"models"=>"ec2/2016-11-15", "endpoint"=>"ec2"}, "ECR"=>{"models"=>"ecr/2015-09-21", "endpoint"=>"ecr"}, "ECS"=>{"models"=>"ecs/2014-11-13", "endpoint"=>"ecs"}, "EFS"=>{"models"=>"elasticfilesystem/2015-02-01", "endpoint"=>"elasticfilesystem"}, "ElastiCache"=>{"models"=>"elasticache/2015-02-02", "endpoint"=>"elasticache"}, "ElasticBeanstalk"=>{"models"=>"elasticbeanstalk/2010-12-01", "endpoint"=>"elasticbeanstalk"}, "ElasticLoadBalancing"=>{"models"=>"elasticloadbalancing/2012-06-01", "endpoint"=>"elasticloadbalancing"}, "ElasticLoadBalancingV2"=>{"models"=>"elasticloadbalancingv2/2015-12-01", "endpoint"=>"elasticloadbalancing"}, "ElasticsearchService"=>{"models"=>"es/2015-01-01", "endpoint"=>"es"}, "ElasticTranscoder"=>{"models"=>"elastictranscoder/2012-09-25", "endpoint"=>"elastictranscoder"}, "EMR"=>{"models"=>"elasticmapreduce/2009-03-31", "endpoint"=>"elasticmapreduce"}, "Firehose"=>{"models"=>"firehose/2015-08-04", "endpoint"=>"firehose"}, "GameLift"=>{"models"=>"gamelift/2015-10-01", "endpoint"=>"gamelift"}, "Glacier"=>{"models"=>"glacier/2012-06-01", "endpoint"=>"glacier"}, "Health"=>{"models"=>"health/2016-08-04", "endpoint"=>"health"}, "IAM"=>{"models"=>"iam/2010-05-08", "endpoint"=>"iam"}, "ImportExport"=>{"models"=>"importexport/2010-06-01", "endpoint"=>"importexport"}, "Inspector"=>{"models"=>"inspector/2016-02-16", "endpoint"=>"inspector"}, "IoT"=>{"models"=>"iot/2015-05-28", "endpoint"=>"iot"}, "IoTDataPlane"=>{"models"=>"iot-data/2015-05-28", "endpoint"=>"data.iot"}, "Kinesis"=>{"models"=>"kinesis/2013-12-02", "endpoint"=>"kinesis"}, "KinesisAnalytics"=>{"models"=>"kinesisanalytics/2015-08-14", "endpoint"=>"kinesisanalytics"}, "KMS"=>{"models"=>"kms/2014-11-01", "endpoint"=>"kms"}, "Lambda"=>{"models"=>"lambda/2015-03-31", "endpoint"=>"lambda"}, "LambdaPreview"=>{"models"=>"lambda/2014-11-11", "endpoint"=>"lambda"}, "Lightsail"=>{"models"=>"lightsail/2016-11-28", "endpoint"=>"lightsail"}, "MachineLearning"=>{"models"=>"machinelearning/2014-12-12", "endpoint"=>"machinelearning"}, "MarketplaceCommerceAnalytics"=>{"models"=>"marketplacecommerceanalytics/2015-07-01", "endpoint"=>"marketplacecommerceanalytics"}, "MarketplaceMetering"=>{"models"=>"meteringmarketplace/2016-01-14", "endpoint"=>"metering.marketplace"}, "OpsWorks"=>{"models"=>"opsworks/2013-02-18", "endpoint"=>"opsworks"}, "OpsWorksCM"=>{"models"=>"opsworkscm/2016-11-01", "endpoint"=>"opsworks-cm"}, "Pinpoint"=>{"models"=>"pinpoint/2016-12-01", "endpoint"=>"pinpoint"}, "Polly"=>{"models"=>"polly/2016-06-10", "endpoint"=>"polly"}, "RDS"=>{"models"=>"rds/2014-10-31", "endpoint"=>"rds"}, "Rekognition"=>{"models"=>"rekognition/2016-06-27", "endpoint"=>"rekognition"}, "Redshift"=>{"models"=>"redshift/2012-12-01", "endpoint"=>"redshift"}, "Route53"=>{"models"=>"route53/2013-04-01", "endpoint"=>"route53"}, "Route53Domains"=>{"models"=>"route53domains/2014-05-15", "endpoint"=>"route53domains"}, "S3"=>{"models"=>"s3/2006-03-01", "endpoint"=>"s3"}, "ServiceCatalog"=>{"models"=>"servicecatalog/2015-12-10", "endpoint"=>"servicecatalog"}, "SES"=>{"models"=>"email/2010-12-01", "endpoint"=>"email"}, "Shield"=>{"models"=>"shield/2016-06-02", "endpoint"=>"shield"}, "SimpleDB"=>{"models"=>"sdb/2009-04-15", "endpoint"=>"sdb"}, "SMS"=>{"models"=>"sms/2016-10-24", "endpoint"=>"sms"}, "SNS"=>{"models"=>"sns/2010-03-31", "endpoint"=>"sns"}, "Snowball"=>{"models"=>"snowball/2016-06-30", "endpoint"=>"snowball"}, "SQS"=>{"models"=>"sqs/2012-11-05", "endpoint"=>"sqs"}, "SSM"=>{"models"=>"ssm/2014-11-06", "endpoint"=>"ssm"}, "States"=>{"models"=>"states/2016-11-23", "endpoint"=>"states"}, "StorageGateway"=>{"models"=>"storagegateway/2013-06-30", "endpoint"=>"storagegateway"}, "STS"=>{"models"=>"sts/2011-06-15", "endpoint"=>"sts"}, "Support"=>{"models"=>"support/2013-04-15", "endpoint"=>"support"}, "SWF"=>{"models"=>"swf/2012-01-25", "endpoint"=>"swf"}, "WAF"=>{"models"=>"waf/2015-08-24", "endpoint"=>"waf"}, "WAFRegional"=>{"models"=>"waf-regional/2016-11-28", "endpoint"=>"waf-regional"}, "WorkSpaces"=>{"models"=>"workspaces/2015-04-08", "endpoint"=>"workspaces"}, "XRay"=>{"models"=>"xray/2016-04-12", "endpoint"=>"xray"}} - Added support for the new 2014-09-01 API version of Amazon Relational Database Service.
