= Getting Started with the AWS SDK for Ruby {<img src="https://secure.travis-ci.org/amazonwebservices/aws-sdk-for-ruby.png" alt="Build Status" />}[http://travis-ci.org/amazonwebservices/aws-sdk-for-ruby]
