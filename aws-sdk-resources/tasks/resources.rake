...
class ResourceDefinitionSorter
  ...
  PATHS = [
    ...
    p('resources'),
    p('resources/\w+', %w(identifiers shape load actions batchActions waiters hasMany belongsTo subResources)),
    ...
    p('resources/\w+/(actions|batchActions|hasMany|belongsTo)'),
    p('resources/\w+/(actions|batchActions|hasMany|belongsTo)/\w+', %w(request resource)),
    p('resources/\w+/(actions|batchActions|hasMany|belongsTo)/\w+/request', %w(operation params)),
    p('resources/\w+/(actions|batchActions|hasMany|belongsTo)/\w+/request/params', %w(target sourceType source)),
    p('resources/\w+/(actions|batchActions|hasMany|belongsTo)/\w+/resource', %w(type identifiers path)),
    p('resources/\w+/(actions|batchActions|hasMany|belongsTo)/\w+/resource/identifiers', %w(target sourceType source)),
