...
module AWS
  class CloudFront
    class Client < Core::RESTClient
      ...
      #   * +:cloud_front_origin_access_identity+ - (Hash)
      #     * +:id+ - (String)
      ...
      #   The #data method of the response object returns
      #   a hash with the following structure:
      #   * +:cloud_front_origin_access_identity_list+ - (Hash)
      #     * +:marker+ - (String)
      #     * +:next_marker+ - (String)
      #     * +:max_items+ - (Integer)
      ...
      #   The #data method of the response object returns
      #   a hash with the following structure:
      #   * +:streaming_distribution_list+ - (Hash)
      #     * +:marker+ - (String)
      #     * +:next_marker+ - (String)
      #     * +:max_items+ - (Integer)
      #     * +:is_truncated+ - (Boolean)
