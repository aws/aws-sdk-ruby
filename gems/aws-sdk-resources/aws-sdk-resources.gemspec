...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency('aws-sdk-arcregionswitch', '~> 1')
  ...
  spec.add_dependency('aws-sdk-computeoptimizerautomation', '~> 1')
  ...
  spec.add_dependency('aws-sdk-connecthealth', '~> 1')
  ...
  spec.add_dependency('aws-sdk-mwaaserverless', '~> 1')
  ...
  spec.add_dependency('aws-sdk-marketplacediscovery', '~> 1')
  ...
  spec.add_dependency('aws-sdk-pricingplanmanager', '~> 1')
  ...
  spec.add_dependency('aws-sdk-resiliencehubv2', '~> 1')
  ...
  spec.add_dependency('aws-sdk-route53globalresolver', '~> 1')
  ...
  spec.add_dependency('aws-sdk-securityagent', '~> 1')
  ...
  spec.add_dependency('aws-sdk-supportauthz', '~> 1')
  spec.add_dependency('aws-sdk-sustainability', '~> 1')
