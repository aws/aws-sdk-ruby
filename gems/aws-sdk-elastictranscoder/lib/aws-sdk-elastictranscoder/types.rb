...
module Aws
  module ElasticTranscoder
    module Types
      ...
      # @note When making an API call, pass AudioCodecOptions
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass AudioParameters
      #   data as a hash:
      #
      #       {
      #         codec: "AudioCodec",
      ...
      # @note When making an API call, pass CaptionFormat
      #   data as a hash:
      #
      #       {
      ...
      # transcoding process.
      # @note When making an API call, pass CaptionSource
      #   data as a hash:
      #
      #       {
      #         key: "LongKey",
      ...
      # @note When making an API call, pass Captions
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass Clip
      #   data as a hash:
      #
      #       {
      #         time_span: {
      ...
      # @note When making an API call, pass CreateJobOutput
      #   data as a hash:
      #
      #       {
      #         key: "Key",
      ...
      # @note When making an API call, pass CreateJobPlaylist
      #   data as a hash:
      #
      #       {
      #         name: "Filename",
      ...
      # @note When making an API call, pass CreatePipelineRequest
      #   data as a hash:
      #
      #       {
      #         name: "Name", # required
      ...
      # @note When making an API call, pass CreatePresetRequest
      #   data as a hash:
      #
      #       {
      #         name: "Name", # required
      ...
      # @note When making an API call, pass DeletePipelineRequest
      #   data as a hash:
      #
      #       {
      #         id: "Id", # required
      ...
      # @note When making an API call, pass DeletePresetRequest
      #   data as a hash:
      #
      #       {
      #         id: "Id", # required
      ...
      # @note When making an API call, pass DetectedProperties
      #   data as a hash:
      #
      #       {
      #         width: 1,
      ...
      # @note When making an API call, pass HlsContentProtection
      #   data as a hash:
      #
      #       {
      #         method: "HlsContentProtectionMethod",
      ...
      # @note When making an API call, pass JobAlbumArt
      #   data as a hash:
      #
      #       {
      #         merge_policy: "MergePolicy",
      ...
      # transparency.
      # @note When making an API call, pass JobWatermark
      #   data as a hash:
      #
      #       {
      #         preset_watermark_id: "PresetWatermarkId",
      ...
      # @note When making an API call, pass ListJobsByPipelineRequest
      #   data as a hash:
      #
      #       {
      #         pipeline_id: "Id", # required
      ...
      # @note When making an API call, pass ListJobsByStatusRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass ListPipelinesRequest
      #   data as a hash:
      #
      #       {
      #         ascending: "Ascending",
      ...
      # @note When making an API call, pass ListPresetsRequest
      #   data as a hash:
      #
      #       {
      #         ascending: "Ascending",
      ...
      # @note When making an API call, pass Permission
      #   data as a hash:
      #
      #       {
      #         grantee_type: "GranteeType",
      ...
      # @note When making an API call, pass PipelineOutputConfig
      #   data as a hash:
      #
      #       {
      #         bucket: "BucketName",
      ...
      # master playlist.
      # @note When making an API call, pass PlayReadyDrm
      #   data as a hash:
      #
      #       {
      #         format: "PlayReadyDrmFormatString",
      ...
      # @note When making an API call, pass PresetWatermark
      #   data as a hash:
      #
      #       {
      #         id: "PresetWatermarkId",
      ...
      # @note When making an API call, pass ReadJobRequest
      #   data as a hash:
      #
      #       {
      #         id: "Id", # required
      ...
      # @note When making an API call, pass ReadPipelineRequest
      #   data as a hash:
      #
      #       {
      #         id: "Id", # required
      ...
      # @note When making an API call, pass ReadPresetRequest
      #   data as a hash:
      #
      #       {
      #         id: "Id", # required
      ...
      # @note When making an API call, pass TestRoleRequest
      #   data as a hash:
      #
      #       {
      #         role: "Role", # required
      ...
      # @note When making an API call, pass Thumbnails
      #   data as a hash:
      #
      #       {
      #         format: "JpgOrPng",
      ...
      # Settings that determine when a clip begins and how long it lasts.
      # @note When making an API call, pass TimeSpan
      #   data as a hash:
      #
      #       {
      #         start_time: "Time",
      ...
      # @note When making an API call, pass UpdatePipelineNotificationsRequest
      #   data as a hash:
      #
      #       {
      #         id: "Id", # required
      ...
      # @note When making an API call, pass UpdatePipelineRequest
      #   data as a hash:
      #
      #       {
      #         id: "Id", # required
      ...
      # @note When making an API call, pass UpdatePipelineStatusRequest
      #   data as a hash:
      #
      #       {
      #         id: "Id", # required
      ...
      # @note When making an API call, pass VideoParameters
      #   data as a hash:
      #
      #       {
      #         codec: "VideoCodec",
