...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-pricingplanmanager'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - PricingPlanManager'
  spec.description   = 'Official AWS Ruby gem for PricingPlanManager. This gem is part of the AWS SDK for Ruby.'
