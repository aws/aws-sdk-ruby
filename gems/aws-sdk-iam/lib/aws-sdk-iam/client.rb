...
Aws::Plugins::GlobalConfiguration::IDENTIFIERS << :iam
...
module Aws
  module IAM
    class Client < Seahorse::Client::Base
      ...
      #   user making the request. The [regex pattern][1] for this parameter is
      ...
      #   the named waiter.
      #
      #   * `:instance_profile_exists` => {#get_instance_profile}
