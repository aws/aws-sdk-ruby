...
module Aws::IAM
  describe EndpointProvider do
    ...
    context 'For region eu-isoe-west-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingName"=>"iam", "signingRegion"=>"eu-isoe-west-1"}]}, "url"=>"https://iam.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context 'For region us-isof-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingName"=>"iam", "signingRegion"=>"us-isof-south-1"}]}, "url"=>"https://iam.us-isof-south-1.csp.hci.ic.gov"}}
      end
