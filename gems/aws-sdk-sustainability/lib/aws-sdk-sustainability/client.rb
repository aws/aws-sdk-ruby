...
module Aws::Sustainability
  ...
  class Client < Seahorse::Client::Base
    ...
    add_plugin(Aws::Sustainability::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::Sustainability::EndpointProvider] :endpoint_provider
    ...
    # Returns estimated carbon emission values based on customer grouping
    ...
    #   or `QUARTERLY_FISCAL` granularity.
    #
    ...
    #
    # @return [Types::GetEstimatedCarbonEmissionsResponse] Returns a {Seahorse::Client::Response response} object which responds to the following methods:
    #
    #   * {Types::GetEstimatedCarbonEmissionsResponse#results #results} => Array&lt;Types::EstimatedCarbonEmissions&gt;
    #   * {Types::GetEstimatedCarbonEmissionsResponse#next_token #next_token} => String
    #
    # The returned {Seahorse::Client::Response response} is a pageable response and is Enumerable. For details on usage see {Aws::PageableResponse PageableResponse}.
    #
    #
    # @example Example: GetEstimatedCarbonEmissionsSuccess
    #
    #   resp = client.get_estimated_carbon_emissions({
    #     emissions_types: [
    ...
    #     ], 
    #     time_period: {
    #       end: Time.parse("2025-12-31T23:59:59.999Z"), 
    #       start: Time.parse("2025-01-01T00:00:00.000Z"), 
    #     }, 
    #   })
    #
    ...
    #         time_period: {
    #           end: Time.parse("2025-02-01T00:00:00Z"), 
    ...
    #   resp.results[0].emissions_values #=> Hash
    #   resp.results[0].emissions_values["EmissionsType"].value #=> Float
    #   resp.results[0].emissions_values["EmissionsType"].unit #=> String, one of "MTCO2e"
    #   resp.next_token #=> String
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/sustainability-2018-05-10/GetEstimatedCarbonEmissions AWS API Documentation
    #
    # @overload get_estimated_carbon_emissions(params = {})
    # @param [Hash] params ({})
    def get_estimated_carbon_emissions(params = {}, options = {})
      req = build_request(:get_estimated_carbon_emissions, params)
    ...
    #   response. If no token is provided, the default page is the first page.
    #
    # @return [Types::GetEstimatedCarbonEmissionsDimensionValuesResponse] Returns a {Seahorse::Client::Response response} object which responds to the following methods:
    #
    #   * {Types::GetEstimatedCarbonEmissionsDimensionValuesResponse#results #results} => Array&lt;Types::DimensionEntry&gt;
    #   * {Types::GetEstimatedCarbonEmissionsDimensionValuesResponse#next_token #next_token} => String
    #
    # The returned {Seahorse::Client::Response response} is a pageable response and is Enumerable. For details on usage see {Aws::PageableResponse PageableResponse}.
    #
    #
    # @example Example: GetEstimatedCarbonEmissionsDimensionValuesSuccess
    #
    #   resp = client.get_estimated_carbon_emissions_dimension_values({
    #     dimensions: [
    #       "REGION", 
    #       "SERVICE", 
    #       "USAGE_ACCOUNT_ID", 
    ...
    #   resp.next_token #=> String
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/sustainability-2018-05-10/GetEstimatedCarbonEmissionsDimensionValues AWS API Documentation
    #
    # @overload get_estimated_carbon_emissions_dimension_values(params = {})
    # @param [Hash] params ({})
    def get_estimated_carbon_emissions_dimension_values(params = {}, options = {})
      req = build_request(:get_estimated_carbon_emissions_dimension_values, params)
      req.send_request(options)
    end
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::Sustainability')
      )
