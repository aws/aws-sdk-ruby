...
module Aws::ECR
  describe EndpointProvider do
    ...
    context "For region af-south-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.af-south-1.api.aws"}}
      end
    ...
    context "For region ap-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-east-1.api.aws"}}
      end
    ...
    context "For region ap-northeast-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-northeast-1.api.aws"}}
      end
    ...
    context "For region ap-northeast-2 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-northeast-2.api.aws"}}
      end
    ...
    context "For region ap-northeast-3 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-northeast-3.api.aws"}}
      end
    ...
    context "For region ap-south-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-south-1.api.aws"}}
      end
    ...
    context "For region ap-south-2 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-south-2.api.aws"}}
      end
    ...
    context "For region ap-southeast-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-southeast-1.api.aws"}}
      end
    ...
    context "For region ap-southeast-2 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-southeast-2.api.aws"}}
      end
    ...
    context "For region ap-southeast-3 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-southeast-3.api.aws"}}
      end
    ...
    context "For region ap-southeast-4 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-southeast-4.api.aws"}}
      end
    ...
    context "For region ap-southeast-5 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.ecr.ap-southeast-5.amazonaws.com"}}
      end
    ...
    context "For region ap-southeast-5 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-southeast-5.api.aws"}}
      end
    ...
    context "For region ap-southeast-7 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.ecr.ap-southeast-7.amazonaws.com"}}
      end

      it 'produces the expected output from the EndpointProvider' do
        params = EndpointParameters.new(**{region: "ap-southeast-7", use_fips: false, use_dual_stack: false})
        endpoint = subject.resolve_endpoint(params)
        expect(endpoint.url).to eq(expected['endpoint']['url'])
        expect(endpoint.headers).to eq(expected['endpoint']['headers'] || {})
        expect(endpoint.properties).to eq(expected['endpoint']['properties'] || {})
    ...
    context "For region ap-southeast-7 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ap-southeast-7.api.aws"}}
      end

      it 'produces the expected output from the EndpointProvider' do
        params = EndpointParameters.new(**{region: "ap-southeast-7", use_fips: false, use_dual_stack: true})
        endpoint = subject.resolve_endpoint(params)
        expect(endpoint.url).to eq(expected['endpoint']['url'])
        expect(endpoint.headers).to eq(expected['endpoint']['headers'] || {})
        expect(endpoint.properties).to eq(expected['endpoint']['properties'] || {})
    ...
    context "For region ca-central-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ca-central-1.api.aws"}}
      end
    ...
    context "For region ca-west-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.ecr.ca-west-1.amazonaws.com"}}
      end
    ...
    context "For region ca-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.ca-west-1.api.aws"}}
      end
    ...
    context "For region eu-central-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.eu-central-1.api.aws"}}
      end
    ...
    context "For region eu-central-2 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.eu-central-2.api.aws"}}
      end
    ...
    context "For region eu-north-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.eu-north-1.api.aws"}}
      end
    ...
    context "For region eu-south-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.eu-south-1.api.aws"}}
      end
    ...
    context "For region eu-south-2 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.eu-south-2.api.aws"}}
      end
    ...
    context "For region eu-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.eu-west-1.api.aws"}}
      end
    ...
    context "For region eu-west-2 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.eu-west-2.api.aws"}}
      end
    ...
    context "For region eu-west-3 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.eu-west-3.api.aws"}}
      end
    ...
    context "For region il-central-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.ecr.il-central-1.amazonaws.com"}}
      end
    ...
    context "For region il-central-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.il-central-1.api.aws"}}
      end

      it 'produces the expected output from the EndpointProvider' do
        params = EndpointParameters.new(**{region: "il-central-1", use_fips: false, use_dual_stack: true})
        endpoint = subject.resolve_endpoint(params)
        expect(endpoint.url).to eq(expected['endpoint']['url'])
        expect(endpoint.headers).to eq(expected['endpoint']['headers'] || {})
        expect(endpoint.properties).to eq(expected['endpoint']['properties'] || {})
    ...
    context "For region me-central-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.me-central-1.api.aws"}}
      end
    ...
    context "For region me-south-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.me-south-1.api.aws"}}
      end
    ...
    context "For region sa-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.sa-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr-fips.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-2 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.us-east-2.api.aws"}}
      end
    ...
    context "For region us-east-2 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr-fips.us-east-2.api.aws"}}
      end
    ...
    context "For region us-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.us-west-1.api.aws"}}
      end
    ...
    context "For region us-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr-fips.us-west-1.api.aws"}}
      end
    ...
    context "For region us-west-2 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.us-west-2.api.aws"}}
      end
    ...
    context "For region us-west-2 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr-fips.us-west-2.api.aws"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr-fips.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr.us-gov-west-1.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://ecr-fips.us-gov-west-1.api.aws"}}
      end
