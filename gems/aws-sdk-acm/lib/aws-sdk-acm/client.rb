...
module Aws::ACM
  ...
  class Client < Seahorse::Client::Base
    ...
    #
    # @option params [required, String, IO like object supporting read, rewind, and size] :passphrase
    ...
    #
    # @option params [required, String, IO like object supporting read, rewind, and size] :private_key
