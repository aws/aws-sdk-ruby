  ...
  module Endpoints
    ...
    class AcceptPortfolioShare
      def self.build(context)
        ...
        Aws::ServiceCatalog::EndpointParameters.new(
    ...
    class NotifyProvisionProductEngineWorkflowResult
      def self.build(context)
        unless context.config.regional_endpoint
          endpoint = context.config.endpoint.to_s
        end
    ...
    class NotifyTerminateProvisionedProductEngineWorkflowResult
      def self.build(context)
        unless context.config.regional_endpoint
          endpoint = context.config.endpoint.to_s
        end
    ...
    class NotifyUpdateProvisionedProductEngineWorkflowResult
      def self.build(context)
        unless context.config.regional_endpoint
          endpoint = context.config.endpoint.to_s
        end
