...
module Aws::ConnectParticipant
  describe EndpointProvider do
    subject { Aws::ConnectParticipant::EndpointProvider.new }

    context 'For region ap-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-south-1.api.aws"}}
      end
    ...
    context 'For region ap-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-south-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-south-1.api.aws"}}
      end
    ...
    context 'For region ap-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-south-1.amazonaws.com"}}
      end
    ...
    context 'For region ca-central-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ca-central-1.api.aws"}}
      end
    ...
    context 'For region ca-central-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ca-central-1.amazonaws.com"}}
      end
    ...
    context 'For region ca-central-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ca-central-1.api.aws"}}
      end
    ...
    context 'For region ca-central-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ca-central-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-central-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.eu-central-1.api.aws"}}
      end
    ...
    context 'For region eu-central-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.eu-central-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-central-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.eu-central-1.api.aws"}}
      end
    ...
    context 'For region eu-central-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.eu-central-1.amazonaws.com"}}
      end
    ...
    context 'For region us-west-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.us-west-2.api.aws"}}
      end
    ...
    context 'For region us-west-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.us-west-2.amazonaws.com"}}
      end
    ...
    context 'For region us-west-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.us-west-2.api.aws"}}
      end
    ...
    context 'For region us-west-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.us-west-2.amazonaws.com"}}
      end
    ...
    context 'For region af-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.af-south-1.api.aws"}}
      end
    ...
    context 'For region af-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.af-south-1.amazonaws.com"}}
      end
    ...
    context 'For region af-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.af-south-1.api.aws"}}
      end
    ...
    context 'For region af-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.af-south-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.eu-west-2.api.aws"}}
      end
    ...
    context 'For region eu-west-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.eu-west-2.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.eu-west-2.api.aws"}}
      end
    ...
    context 'For region eu-west-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.eu-west-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-northeast-2.api.aws"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-northeast-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-northeast-2.api.aws"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-northeast-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-northeast-1.api.aws"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-northeast-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-northeast-1.api.aws"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-northeast-1.amazonaws.com"}}
      end
    ...
    context 'For region us-gov-west-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.us-gov-west-1.api.aws"}}
      end
    ...
    context 'For region us-gov-west-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.us-gov-west-1.amazonaws.com"}}
      end
    ...
    context 'For region us-gov-west-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.us-gov-west-1.api.aws"}}
      end
    ...
    context 'For region us-gov-west-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.us-gov-west-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-southeast-1.api.aws"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-southeast-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-southeast-1.api.aws"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-southeast-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-southeast-2.api.aws"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.ap-southeast-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-southeast-2.api.aws"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.ap-southeast-2.amazonaws.com"}}
      end
    ...
    context 'For region us-east-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.us-east-1.api.aws"}}
      end
    ...
    context 'For region us-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect-fips.us-east-1.amazonaws.com"}}
      end
    ...
    context 'For region us-east-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.us-east-1.api.aws"}}
      end
    ...
    context 'For region us-east-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://participant.connect.us-east-1.amazonaws.com"}}
      end
