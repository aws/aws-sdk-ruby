...
module Aws::MediaConvert
  ...
  # When MediaConvert returns an error response, the Ruby SDK constructs and raises an error.
  # These errors all extend Aws::MediaConvert::Errors::ServiceError < {Aws::Errors::ServiceError}
  #
