...
{"region":"us-east-1","use_fips_endpoint":false,"use_dualstack_endpoint":false}
    ...
    When I call the operation 'create_outbound_external_link' with params:
      """
{"gateway_id":"rtb-gw-12345","public_endpoint":"https://example.com","client_token":"mno345pqr678","log_settings":{"application_logs":{"sampling":{"error_log":100.0,"filter_log":0.0}}}}
      """
    Then I expect an error was not raised
...
{"region":"us-east-1","use_fips_endpoint":false,"use_dualstack_endpoint":false}
    ...
    When I call the operation 'create_inbound_external_link' with params:
      """
{"gateway_id":"rtb-gw-12345","client_token":"abc123def456","log_settings":{"application_logs":{"sampling":{"error_log":100.0,"filter_log":0.0}}}}
      """
    Then I expect an error was not raised
