...
module Aws::Lightsail
  ...
  class Client < Seahorse::Client::Base
    ...
    # that makes the request. The response includes the profile type and,
    # for accounts enrolled in the Lightsail partner program, the partner
    # membership details.
    #
    # @return [Types::GetProfileResult] Returns a {Seahorse::Client::Response response} object which responds to the following methods:
    #
    #   * {Types::GetProfileResult#profile_type #profile_type} => String
    #   * {Types::GetProfileResult#partner #partner} => Types::PartnerInfo
    #
    # @example Response structure
    #
    #   resp.profile_type #=> String, one of "Lightsailor", "LightsailPartner"
    #   resp.partner.enrolled_at #=> Time
    #   resp.partner.tier_name #=> String, one of "Essential", "Growth", "Accelerate", "Premier"
    #   resp.partner.status #=> String, one of "Active", "Suspended"
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetProfile AWS API Documentation
    #
    ...
    #     relational_database_name: "ResourceName", # required
    #     metric_name: "CPUUtilization", # required, accepts CPUUtilization, DatabaseConnections, DiskQueueDepth, FreeStorageSpace, NetworkReceiveThroughput, NetworkTransmitThroughput, FreeableMemory, SwapUsage
    #     period: 1, # required
    #     start_time: Time.now, # required
    #     end_time: Time.now, # required
    #     unit: "Seconds", # required, accepts Seconds, Microseconds, Milliseconds, Bytes, Kilobytes, Megabytes, Gigabytes, Terabytes, Bits, Kilobits, Megabits, Gigabits, Terabits, Percent, Count, Bytes/Second, Kilobytes/Second, Megabytes/Second, Gigabytes/Second, Terabytes/Second, Bits/Second, Kilobits/Second, Megabits/Second, Gigabits/Second, Terabits/Second, Count/Second, None
    ...
    # @example Response structure
    #
    #   resp.metric_name #=> String, one of "CPUUtilization", "DatabaseConnections", "DiskQueueDepth", "FreeStorageSpace", "NetworkReceiveThroughput", "NetworkTransmitThroughput", "FreeableMemory", "SwapUsage"
    #   resp.metric_data #=> Array
    #   resp.metric_data[0].average #=> Float
    #   resp.metric_data[0].maximum #=> Float
    #   resp.metric_data[0].minimum #=> Float
