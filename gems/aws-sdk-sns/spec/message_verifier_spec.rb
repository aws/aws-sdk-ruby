...
-----END CERTIFICATE-----
      ...
      describe '#authenticate!' do
        ...
        it 'returns true for a valid message' do
          expect(verifier.authenticate!(message_SHA1)).to be(true)
        end

        it 'returns true for a valid message' do
          expect(verifier.authenticate!(message_SHA256)).to be(true)
        end
      ...
      describe '#authentic?' do
        ...
        it 'returns true if the message can be authenticated' do
          expect(verifier.authentic?(message_SHA1)).to be(true)
        end
