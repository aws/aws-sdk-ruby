...
Gem::Specification.new do |spec|
  ...
  spec.description   = '[DEPRECATED] Official AWS Ruby gem for AWS IoT Events. This gem is part of the AWS SDK for Ruby.'
  ...
  spec.post_install_message = '*** aws-sdk-iotevents is deprecated ***'
end
