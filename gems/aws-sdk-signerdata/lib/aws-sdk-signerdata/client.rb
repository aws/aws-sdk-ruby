...
module Aws::SignerData
  # An API client for SignerData.  To construct a client, you need to configure a `:region` and `:credentials`.
  #
  #     client = Aws::SignerData::Client.new(
  #       region: region_name,
  ...
  class Client < Seahorse::Client::Base
    ...
    add_plugin(Aws::SignerData::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::SignerData::EndpointProvider] :endpoint_provider
    ...
    # Retrieves the revocation status for a signed artifact by checking if
    ...
    #
    #
    # @example Example: Check revocation status for a signed artifact
    #
    ...
    #     ], 
    #     job_arn: "arn:aws:signer:us-east-1:123456789012:/signing-jobs/my-job-id", 
    #     platform_id: "Notation-OCI-SHA384-ECDSA", 
    #     profile_version_arn: "arn:aws:signer:us-east-1:123456789012:/signing-profiles/my-profile/v1", 
    #     signature_timestamp: Time.parse(1700000000), 
    #   })
    #
    ...
    #     certificate_hashes: ["CertificateHash"], # required
    #   })
    #
    ...
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/signer-data-2017-08-25/GetRevocationStatus AWS API Documentation
    #
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::SignerData')
      )
      ...
      context[:gem_name] = 'aws-sdk-signerdata'
