...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-networkmonitor'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon CloudWatch Network Monitor'
  spec.description   = 'Official AWS Ruby gem for Amazon CloudWatch Network Monitor. This gem is part of the AWS SDK for Ruby.'
