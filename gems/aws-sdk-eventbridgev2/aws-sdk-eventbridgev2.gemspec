...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-eventbridgev2'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon EventBridgeV2'
  spec.description   = 'Official AWS Ruby gem for Amazon EventBridgeV2. This gem is part of the AWS SDK for Ruby.'
