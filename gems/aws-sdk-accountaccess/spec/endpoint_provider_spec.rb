...
module Aws::AccountAccess
  describe EndpointProvider do
    subject { Aws::AccountAccess::EndpointProvider.new }
    ...
    context "For region us-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://account-access-fips.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://account-access.us-east-1.api.aws"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://account-access-fips.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://account-access.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://account-access-fips.us-gov-west-1.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://account-access.us-gov-west-1.api.aws"}}
      end
