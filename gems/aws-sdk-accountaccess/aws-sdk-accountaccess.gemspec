...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-accountaccess'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Account Access'
  spec.description   = 'Official AWS Ruby gem for Account Access. This gem is part of the AWS SDK for Ruby.'
