...
module Aws::MarketplaceEntitlementService
  ...
  class Client < Seahorse::Client::Base
    ...
    #     The endpoint provider used to resolve endpoints. Any object that responds to `#resolve_endpoint(parameters)` where `parameters` is a Struct similar to `Aws::MarketplaceEntitlementService::EndpointParameters`
    #
