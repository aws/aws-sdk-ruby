...
module Aws::MarketplaceCatalog
  describe EndpointProvider do
    ...
    context "For region us-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://catalog.marketplace-fips.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://catalog.marketplace-fips.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://catalog.marketplace-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://catalog.marketplace.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://catalog.marketplace-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://catalog.marketplace.us-isob-east-1.sc2s.sgov.gov"}}
      end
