...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-notifications'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS User Notifications'
  spec.description   = 'Official AWS Ruby gem for AWS User Notifications. This gem is part of the AWS SDK for Ruby.'
