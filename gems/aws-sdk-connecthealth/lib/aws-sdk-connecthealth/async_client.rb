...
module Aws::ConnectHealth
  ...
  class AsyncClient < Seahorse::Client::AsyncBase
    ...
    add_plugin(Aws::ConnectHealth::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::ConnectHealth::EndpointProvider] :endpoint_provider
    ...
    #
    # @return [Types::StartMedicalScribeListeningSessionOutput] Returns a {Seahorse::Client::Response response} object which responds to the following methods:
    #
    #   * {Types::StartMedicalScribeListeningSessionOutput#session_id #session_id} => String
    #   * {Types::StartMedicalScribeListeningSessionOutput#domain_id #domain_id} => String
    #   * {Types::StartMedicalScribeListeningSessionOutput#subscription_id #subscription_id} => String
    #   * {Types::StartMedicalScribeListeningSessionOutput#request_id #request_id} => String
    #   * {Types::StartMedicalScribeListeningSessionOutput#language_code #language_code} => String
    #   * {Types::StartMedicalScribeListeningSessionOutput#media_sample_rate_hertz #media_sample_rate_hertz} => Integer
    #   * {Types::StartMedicalScribeListeningSessionOutput#media_encoding #media_encoding} => String
    #   * {Types::StartMedicalScribeListeningSessionOutput#response_stream #response_stream} => Types::MedicalScribeOutputStream
    #
    ...
    #   # Aws::ConnectHealth::EventStreams::MedicalScribeInputStream object.
    #   # You must signal events before calling #wait or #join! on the async response.
    #   input_stream = Aws::ConnectHealth::EventStreams::MedicalScribeInputStream.new
    #
    #   async_resp = client.start_medical_scribe_listening_session(
    #     # params input
    #     input_event_stream_handler: input_stream
    #   ) do |out_stream|
    #     # register callbacks for events
    #     out_stream.on_transcript_event_event do |event|
    #       event # => Aws::ConnectHealth::Types::transcriptEvent
    #     end
    #     out_stream.on_internal_failure_exception_event do |event|
    #       event # => Aws::ConnectHealth::Types::internalFailureException
    #     end
    #     out_stream.on_validation_exception_event do |event|
    #       event # => Aws::ConnectHealth::Types::validationException
    #     end
    #   end
    ...
    #
    #   # You can also provide an Aws::ConnectHealth::EventStreams::MedicalScribeOutputStream object
    #   # to register callbacks before initializing the request instead of processing
    #   # from the request block.
    #   output_stream = Aws::ConnectHealth::EventStreams::MedicalScribeOutputStream.new
    #
    ...
    #
    #   async_resp = async_client.start_medical_scribe_listening_session({
    ...
    #   resp.response_stream #=> Enumerator
    #   resp.response_stream.event_types #=> [:transcript_event, :internal_failure_exception, :validation_exception]
    #
    ...
    #   event.transcript_segment.audio_begin_offset #=> Float
    #   event.transcript_segment.audio_end_offset #=> Float
    ...
    #   event.message #=> String
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/connecthealth-2025-01-29/StartMedicalScribeListeningSession AWS API Documentation
    #
    # @overload start_medical_scribe_listening_session(params = {})
    # @param [Hash] params ({})
    def start_medical_scribe_listening_session(params = {}, options = {}, &block)
      params = params.dup
      ...
      output_event_stream_handler = _event_stream_handler(
        ...
        EventStreams::MedicalScribeOutputStream
      )

      yield(output_event_stream_handler) if block_given?

      req = build_request(:start_medical_scribe_listening_session, params)
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::ConnectHealth')
      )
    ...
    def _event_stream_handler(type, handler, event_stream_class)
      ...
      when nil then event_stream_class.new
        ...
        msg = "expected #{type}_event_stream_handler to be a block or "\
              "instance of Aws::ConnectHealth::#{event_stream_class}"\
