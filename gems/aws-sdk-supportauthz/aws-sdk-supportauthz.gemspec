...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-supportauthz'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - SupportAuthZ'
  spec.description   = 'Official AWS Ruby gem for SupportAuthZ. This gem is part of the AWS SDK for Ruby.'
