...
module Aws::AgentRegistryControl
  ...
  module Waiters
    ...
    class RegistryReady
      ...
      # @option (see Client#get_registry)
      # @return (see Client#get_registry)
      def wait(params = {})
    ...
    class RegistryRecordApproved
      ...
      # @option (see Client#get_registry_record)
      # @return (see Client#get_registry_record)
      def wait(params = {})
        @waiter.wait(client: @client, params: params)
      end
