...
Aws::Plugins::GlobalConfiguration.add_identifier(:emrserverlesswebservice)

module Aws::EMRServerlessWebService
  # An API client for EMRServerlessWebService.  To construct a client, you need to configure a `:region` and `:credentials`.
  #
  #     client = Aws::EMRServerlessWebService::Client.new(
  #       region: region_name,
  ...
  class Client < Seahorse::Client::Base
    ...
    @identifier = :emrserverlesswebservice
    ...
    def build_request(operation_name, params = {})
      ...
      context = Seahorse::Client::RequestContext.new(
        ...
        params: params,
        config: config)
      context[:gem_name] = 'aws-sdk-emrserverlesswebservice'
