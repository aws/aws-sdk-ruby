...
module Aws::ConfigService
  ...
  class Client < Seahorse::Client::Base
    ...
    # enforced by Config Custom Policy rules. Lambda uses custom code that
    # you upload to evaluate a custom rule. If you are adding a new Custom
    # Lambda rule, you first need to create an Lambda function in the
    # management account or a delegated administrator that the rule invokes
    # to evaluate your resources. You also need to create an IAM role in the
    # managed account that can be assumed by the Lambda function. When you
    # use `PutOrganizationConfigRule` to add a Custom Lambda rule to Config,
