...
module Aws::ApiGatewayManagementApi
  ...
  class Client < Seahorse::Client::Base
    ...
    add_plugin(Aws::ApiGatewayManagementApi::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::ApiGatewayManagementApi::EndpointProvider] :endpoint_provider
    #     The endpoint provider used to resolve endpoints. Any object that responds to `#resolve_endpoint(parameters)` where `parameters` is a Struct similar to `Aws::ApiGatewayManagementApi::EndpointParameters`
    #
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::ApiGatewayManagementApi')
      )
