...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency('aws-partitions', '~> 1', '>= 1.650.0') # necessary for new endpoint resolution
  spec.add_dependency('aws-sigv4', '~> 1.1') # necessary for making Aws::STS, SSO, SSOOIDC API calls
