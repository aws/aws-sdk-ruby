...
module Aws
  describe ProcessCredentials do
    ...
    it 'will read credentials from a process' do
      creds = ProcessCredentials.new('echo \'{"Version":1,"AccessKeyId":"AK_PROC1","SecretAccessKey":"SECRET_AK_PROC1","SessionToken":"TOKEN_PROC1","AccountId":"ACCOUNT_ID_PROC1"}\'').credentials
