...
JSON
      ...
      it 'raises exceptions when a nested structure member is not JSON serializable' do
        expect do
          client.foo(
            body: {
              body_structure_field: {
                body_field: hash_no_json
                 ...
                 ArgumentError,
                 "The value of params[body][body_structure_field][body_field] is not JSON serializable.")
      end
          ...
          client.foo(
            body: {
              body_list_field: [hash, hash_no_json]
                 ...
                 ArgumentError,
                 "The value of params[body][body_list_field][1] is not JSON serializable.")
      end
          ...
          client.foo(
            body: {
              body_map_field: {key1: hash, key2: hash_no_json}
                 ...
                 ArgumentError,
                 "The value of params[body][body_map_field][key2] is not JSON serializable.")
      end
    end
  end
end
