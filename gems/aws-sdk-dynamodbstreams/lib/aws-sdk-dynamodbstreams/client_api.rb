...
module Aws::DynamoDBStreams
  ...
  module ClientApi
    ...
    EmptySetAttributeValue = Shapes::ListShape.new(name: 'EmptySetAttributeValue')
    ...
    AttributeValue.add_member(:es, Shapes::ShapeRef.new(shape: EmptySetAttributeValue, location_name: "ES"))
