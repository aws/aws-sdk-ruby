...
module Aws::LicenseManager
  describe EndpointProvider do
    subject { Aws::LicenseManager::EndpointProvider.new }

    context 'For region ap-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-south-1.api.aws"}}
      end
    ...
    context 'For region ap-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-south-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-south-1.api.aws"}}
      end
    ...
    context 'For region ap-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-south-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-south-1.api.aws"}}
      end
    ...
    context 'For region eu-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-south-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-south-1.api.aws"}}
      end
    ...
    context 'For region eu-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-south-1.amazonaws.com"}}
      end
    ...
    context 'For region us-gov-east-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-gov-east-1.api.aws"}}
      end
    ...
    context 'For region us-gov-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context 'For region us-gov-east-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-gov-east-1.api.aws"}}
      end
    ...
    context 'For region us-gov-east-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context 'For region ca-central-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ca-central-1.api.aws"}}
      end
    ...
    context 'For region ca-central-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ca-central-1.amazonaws.com"}}
      end
    ...
    context 'For region ca-central-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ca-central-1.api.aws"}}
      end
    ...
    context 'For region ca-central-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ca-central-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-central-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-central-1.api.aws"}}
      end
    ...
    context 'For region eu-central-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-central-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-central-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-central-1.api.aws"}}
      end
    ...
    context 'For region eu-central-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-central-1.amazonaws.com"}}
      end
    ...
    context 'For region us-west-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-west-1.api.aws"}}
      end
    ...
    context 'For region us-west-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-west-1.amazonaws.com"}}
      end
    ...
    context 'For region us-west-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-west-1.api.aws"}}
      end
    ...
    context 'For region us-west-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-west-1.amazonaws.com"}}
      end
    ...
    context 'For region us-west-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-west-2.api.aws"}}
      end
    ...
    context 'For region us-west-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-west-2.amazonaws.com"}}
      end
    ...
    context 'For region us-west-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-west-2.api.aws"}}
      end
    ...
    context 'For region us-west-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-west-2.amazonaws.com"}}
      end
    ...
    context 'For region af-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.af-south-1.api.aws"}}
      end
    ...
    context 'For region af-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.af-south-1.amazonaws.com"}}
      end
    ...
    context 'For region af-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.af-south-1.api.aws"}}
      end
    ...
    context 'For region af-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.af-south-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-north-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-north-1.api.aws"}}
      end
    ...
    context 'For region eu-north-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-north-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-north-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-north-1.api.aws"}}
      end
    ...
    context 'For region eu-north-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-north-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-3 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-west-3.api.aws"}}
      end
    ...
    context 'For region eu-west-3 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-west-3.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-3 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-west-3.api.aws"}}
      end
    ...
    context 'For region eu-west-3 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-west-3.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-west-2.api.aws"}}
      end
    ...
    context 'For region eu-west-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-west-2.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-west-2.api.aws"}}
      end
    ...
    context 'For region eu-west-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-west-2.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-west-1.api.aws"}}
      end
    ...
    context 'For region eu-west-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.eu-west-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-west-1.api.aws"}}
      end
    ...
    context 'For region eu-west-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.eu-west-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-3 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-northeast-3.api.aws"}}
      end
    ...
    context 'For region ap-northeast-3 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-northeast-3.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-3 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-northeast-3.api.aws"}}
      end
    ...
    context 'For region ap-northeast-3 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-northeast-3.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-northeast-2.api.aws"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-northeast-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-northeast-2.api.aws"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-northeast-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-northeast-1.api.aws"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-northeast-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-northeast-1.api.aws"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-northeast-1.amazonaws.com"}}
      end
    ...
    context 'For region me-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.me-south-1.api.aws"}}
      end
    ...
    context 'For region me-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.me-south-1.amazonaws.com"}}
      end
    ...
    context 'For region me-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.me-south-1.api.aws"}}
      end
    ...
    context 'For region me-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.me-south-1.amazonaws.com"}}
      end
    ...
    context 'For region sa-east-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.sa-east-1.api.aws"}}
      end
    ...
    context 'For region sa-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.sa-east-1.amazonaws.com"}}
      end
    ...
    context 'For region sa-east-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.sa-east-1.api.aws"}}
      end
    ...
    context 'For region sa-east-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.sa-east-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-east-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-east-1.api.aws"}}
      end
    ...
    context 'For region ap-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-east-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-east-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-east-1.api.aws"}}
      end
    ...
    context 'For region ap-east-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-east-1.amazonaws.com"}}
      end
    ...
    context 'For region cn-north-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context 'For region cn-north-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context 'For region cn-north-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context 'For region cn-north-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context 'For region us-gov-west-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-gov-west-1.api.aws"}}
      end
    ...
    context 'For region us-gov-west-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-gov-west-1.amazonaws.com"}}
      end
    ...
    context 'For region us-gov-west-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-gov-west-1.api.aws"}}
      end
    ...
    context 'For region us-gov-west-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-gov-west-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-southeast-1.api.aws"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-southeast-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-southeast-1.api.aws"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-southeast-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-southeast-2.api.aws"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-southeast-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-southeast-2.api.aws"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-southeast-2.amazonaws.com"}}
      end
    ...
    context 'For region us-iso-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context 'For region us-iso-east-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context 'For region ap-southeast-3 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-southeast-3.api.aws"}}
      end
    ...
    context 'For region ap-southeast-3 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.ap-southeast-3.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-3 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-southeast-3.api.aws"}}
      end
    ...
    context 'For region ap-southeast-3 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.ap-southeast-3.amazonaws.com"}}
      end
    ...
    context 'For region us-east-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-east-1.api.aws"}}
      end
    ...
    context 'For region us-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-east-1.amazonaws.com"}}
      end
    ...
    context 'For region us-east-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-east-1.api.aws"}}
      end
    ...
    context 'For region us-east-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-east-1.amazonaws.com"}}
      end
    ...
    context 'For region us-east-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-east-2.api.aws"}}
      end
    ...
    context 'For region us-east-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-east-2.amazonaws.com"}}
      end
    ...
    context 'For region us-east-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-east-2.api.aws"}}
      end
    ...
    context 'For region us-east-2 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-east-2.amazonaws.com"}}
      end
    ...
    context 'For region cn-northwest-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context 'For region cn-northwest-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.cn-northwest-1.amazonaws.com.cn"}}
      end
    ...
    context 'For region cn-northwest-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context 'For region cn-northwest-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.cn-northwest-1.amazonaws.com.cn"}}
      end
    ...
    context 'For region us-isob-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context 'For region us-isob-east-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://license-manager.us-isob-east-1.sc2s.sgov.gov"}}
      end
