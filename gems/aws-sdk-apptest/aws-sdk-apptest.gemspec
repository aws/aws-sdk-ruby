...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-apptest'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Mainframe Modernization Application Testing'
  spec.description   = 'Official AWS Ruby gem for AWS Mainframe Modernization Application Testing. This gem is part of the AWS SDK for Ruby.'
  ...
  spec.add_dependency('aws-sdk-core', '~> 3', '>= 3.203.0')
