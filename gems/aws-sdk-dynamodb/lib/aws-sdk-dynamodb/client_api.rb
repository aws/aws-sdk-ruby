...
module Aws::DynamoDB
  ...
  module ClientApi
    ...
    AttributeValue.add_member_subclass(:b, Types::AttributeValue::B)
    AttributeValue.add_member_subclass(:ss, Types::AttributeValue::SS)
    AttributeValue.add_member_subclass(:ns, Types::AttributeValue::NS)
    AttributeValue.add_member_subclass(:bs, Types::AttributeValue::BS)
    AttributeValue.add_member_subclass(:m, Types::AttributeValue::M)
    AttributeValue.add_member_subclass(:l, Types::AttributeValue::L)
    AttributeValue.add_member_subclass(:null, Types::AttributeValue::NULL)
