...
module Aws
  module DynamoDB
    module Types
      ...
      # and indexes.
      # @note When making an API call, pass AttributeDefinition
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass AttributeValueUpdate
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass BatchGetItemInput
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass BatchWriteItemInput
      #   data as a hash:
      #
      #       {
      #         request_items: { # required
      ...
      # table.
      # @note When making an API call, pass CreateGlobalSecondaryIndexAction
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass CreateTableInput
      #   data as a hash:
      #
      #       {
      ...
      # table.
      # @note When making an API call, pass DeleteGlobalSecondaryIndexAction
      #   data as a hash:
      #
      #       {
      #         index_name: "IndexName", # required
      ...
      # @note When making an API call, pass DeleteItemInput
      #   data as a hash:
      #
      #       {
      #         table_name: "TableName", # required
      ...
      # @note When making an API call, pass DeleteRequest
      #   data as a hash:
      #
      #       {
      #         key: { # required
      ...
      # @note When making an API call, pass DeleteTableInput
      #   data as a hash:
      #
      #       {
      #         table_name: "TableName", # required
      ...
      # @note When making an API call, pass DescribeTableInput
      #   data as a hash:
      #
      #       {
      #         table_name: "TableName", # required
      ...
      # @note When making an API call, pass ExpectedAttributeValue
      #   data as a hash:
      #
      #       {
      #         value: "value", # value <Hash,Array,String,Numeric,Boolean,IO,Set,nil>
      ...
      # @note When making an API call, pass GetItemInput
      #   data as a hash:
      #
      #       {
      #         table_name: "TableName", # required
      ...
      # @note When making an API call, pass GlobalSecondaryIndex
      #   data as a hash:
      #
      #       {
      #         index_name: "IndexName", # required
      ...
      #   table.
      # @note When making an API call, pass GlobalSecondaryIndexUpdate
      #   data as a hash:
      #
      #       {
      #         update: {
      ...
      # @note When making an API call, pass KeySchemaElement
      #   data as a hash:
      #
      #       {
      #         attribute_name: "KeySchemaAttributeName", # required
      ...
      # @note When making an API call, pass KeysAndAttributes
      #   data as a hash:
      #
      #       {
      #         keys: [ # required
      ...
      # @note When making an API call, pass ListTablesInput
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass LocalSecondaryIndex
      #   data as a hash:
      #
      #       {
      #         index_name: "IndexName", # required
      ...
      # @note When making an API call, pass Projection
      #   data as a hash:
      #
      #       {
      #         projection_type: "ALL", # accepts ALL, KEYS_ONLY, INCLUDE
      ...
      #
      # [1]: http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Limits.html
      # @note When making an API call, pass ProvisionedThroughput
      #   data as a hash:
      #
      #       {
      #         read_capacity_units: 1, # required
      ...
      # @note When making an API call, pass PutRequest
      #   data as a hash:
      #
      #       {
      #         item: { # required
      ...
      # @note When making an API call, pass QueryInput
      #   data as a hash:
      #
      #       {
      #         table_name: "TableName", # required
      ...
      # @note When making an API call, pass ScanInput
      #   data as a hash:
      #
      #       {
      #         table_name: "TableName", # required
      ...
      # @note When making an API call, pass StreamSpecification
      #   data as a hash:
      #
      #       {
      #         stream_enabled: false,
      ...
      # @note When making an API call, pass UpdateGlobalSecondaryIndexAction
      #   data as a hash:
      #
      #       {
      #         index_name: "IndexName", # required
      ...
      # @note When making an API call, pass UpdateItemInput
      #   data as a hash:
      #
      #       {
      #         table_name: "TableName", # required
      ...
      # @note When making an API call, pass UpdateTableInput
      #   data as a hash:
      #
      #       {
      #         attribute_definitions: [
      ...
      # @note When making an API call, pass WriteRequest
      #   data as a hash:
      #
      #       {
      #         put_request: {
