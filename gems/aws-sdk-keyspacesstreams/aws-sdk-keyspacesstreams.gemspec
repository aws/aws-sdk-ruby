...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-keyspacesstreams'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon Keyspaces Streams'
  spec.description   = 'Official AWS Ruby gem for Amazon Keyspaces Streams. This gem is part of the AWS SDK for Ruby.'
