...
module Aws::KeyspacesStreams
  describe EndpointProvider do
    ...
    context "For region us-iso-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://cassandra-streams-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://cassandra-streams.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://cassandra-streams-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://cassandra-streams.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region eu-isoe-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://cassandra-streams-fips.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context "For region eu-isoe-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://cassandra-streams.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context "For region us-isof-south-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://cassandra-streams-fips.us-isof-south-1.csp.hci.ic.gov"}}
      end
    ...
    context "For region us-isof-south-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://cassandra-streams.us-isof-south-1.csp.hci.ic.gov"}}
      end
