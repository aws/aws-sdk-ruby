...
module Aws::CodeGuruReviewer
  ...
  module Waiters
    ...
    class CodeReviewCompleted
      ...
      # @option (see Client#describe_code_review)
      # @return (see Client#describe_code_review)
      def wait(params = {})
    ...
    class RepositoryAssociationSucceeded
      ...
      # @option (see Client#describe_repository_association)
      # @return (see Client#describe_repository_association)
      def wait(params = {})
        @waiter.wait(client: @client, params: params)
      end
