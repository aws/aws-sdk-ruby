...
module Aws::IoTFleetWise
  describe EndpointProvider do
    subject { Aws::IoTFleetWise::EndpointProvider.new }

    context "For region eu-central-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.eu-central-1.amazonaws.com"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise-fips.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise-fips.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.us-east-1.api.aws"}}
      end
    ...
    context "For region cn-north-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise-fips.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise-fips.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise-fips.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise-fips.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://iotfleetwise.us-isob-east-1.sc2s.sgov.gov"}}
      end
