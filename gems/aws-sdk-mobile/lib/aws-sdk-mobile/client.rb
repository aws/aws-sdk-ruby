...
module Aws::Mobile
  ...
  class Client < Seahorse::Client::Base
    ...
    add_plugin(Aws::Mobile::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::Mobile::EndpointProvider] :endpoint_provider
    #     The endpoint provider used to resolve endpoints. Any object that responds to `#resolve_endpoint(parameters)` where `parameters` is a Struct similar to `Aws::Mobile::EndpointParameters`
    #
