...
module Aws
  module OpsWorks
    module Types
      ...
      # @note When making an API call, pass AssignInstanceRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass AssignVolumeRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass AssociateElasticIpRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass AttachElasticLoadBalancerRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass AutoScalingThresholds
      #   data as a hash:
      #
      #       {
      #         instance_count: 1,
      ...
      class AutoScalingThresholds < Aws::Structure.new(
        ...
        #
        #   <note>To use custom alarms, you must update your service role to allow `cloudwatch:DescribeAlarms`. You can either have AWS OpsWorks update the role for you when you first use this feature or you can edit the role manually. For more information, see [Allowing AWS OpsWorks to Act on Your Behalf][1].</note>
        #
        #
        #
      ...
      # @note When making an API call, pass ChefConfiguration
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass CloneStackRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass CreateAppRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass CreateInstanceRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass CreateLayerRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass CreateUserProfileRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass DeleteAppRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass DeleteLayerRequest
      #   data as a hash:
      #
      #       {
      #         layer_id: "String", # required
      ...
      # @note When making an API call, pass DeleteUserProfileRequest
      #   data as a hash:
      #
      #       {
      #         iam_user_arn: "String", # required
      ...
      # Used to specify a stack or deployment command.
      # @note When making an API call, pass DeploymentCommand
      #   data as a hash:
      #
      #       {
      #         name: "install_dependencies", # required, accepts install_dependencies, update_dependencies, update_custom_cookbooks, execute_recipes, configure, setup, deploy, rollback, start, stop, restart, undeploy
      ...
      # @note When making an API call, pass DeregisterEcsClusterRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass DeregisterElasticIpRequest
      #   data as a hash:
      #
      #       {
      #         elastic_ip: "String", # required
      ...
      # @note When making an API call, pass DeregisterInstanceRequest
      #   data as a hash:
      #
      #       {
      #         instance_id: "String", # required
      ...
      # @note When making an API call, pass DeregisterRdsDbInstanceRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass DeregisterVolumeRequest
      #   data as a hash:
      #
      #       {
      #         volume_id: "String", # required
      ...
      # @note When making an API call, pass DescribeAgentVersionsRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String",
      ...
      # @note When making an API call, pass DescribeAppsRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String",
      ...
      # @note When making an API call, pass DescribeCommandsRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass DescribeDeploymentsRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String",
      ...
      # @note When making an API call, pass DescribeEcsClustersRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass DescribeElasticIpsRequest
      #   data as a hash:
      #
      #       {
      #         instance_id: "String",
      ...
      # @note When making an API call, pass DescribeElasticLoadBalancersRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String",
      ...
      # @note When making an API call, pass DescribeLayersRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String",
      ...
      # @note When making an API call, pass DescribeLoadBasedAutoScalingRequest
      #   data as a hash:
      #
      #       {
      #         layer_ids: ["String"], # required
      ...
      # @note When making an API call, pass DescribePermissionsRequest
      #   data as a hash:
      #
      #       {
      #         iam_user_arn: "String",
      ...
      # @note When making an API call, pass DescribeRaidArraysRequest
      #   data as a hash:
      #
      #       {
      #         instance_id: "String",
      ...
      # @note When making an API call, pass DescribeRdsDbInstancesRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass DescribeServiceErrorsRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String",
      ...
      # @note When making an API call, pass DescribeStackProvisioningParametersRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass DescribeStackSummaryRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass DescribeTimeBasedAutoScalingRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass DescribeUserProfilesRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass DetachElasticLoadBalancerRequest
      #   data as a hash:
      #
      #       {
      #         elastic_load_balancer_name: "String", # required
      ...
      # @note When making an API call, pass DisassociateElasticIpRequest
      #   data as a hash:
      #
      #       {
      #         elastic_ip: "String", # required
      ...
      # @note When making an API call, pass GetHostnameSuggestionRequest
      #   data as a hash:
      #
      #       {
      #         layer_id: "String", # required
      ...
      # @note When making an API call, pass GrantAccessRequest
      #   data as a hash:
      #
      #       {
      #         instance_id: "String", # required
      ...
      # @note When making an API call, pass LifecycleEventConfiguration
      #   data as a hash:
      #
      #       {
      #         shutdown: {
      ...
      # @note When making an API call, pass RegisterEcsClusterRequest
      #   data as a hash:
      #
      #       {
      #         ecs_cluster_arn: "String", # required
      ...
      # @note When making an API call, pass RegisterElasticIpRequest
      #   data as a hash:
      #
      #       {
      #         elastic_ip: "String", # required
      ...
      # @note When making an API call, pass RegisterInstanceRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass RegisterRdsDbInstanceRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass RegisterVolumeRequest
      #   data as a hash:
      #
      #       {
      ...
      # @note When making an API call, pass SetLoadBasedAutoScalingRequest
      #   data as a hash:
      #
      #       {
      #         layer_id: "String", # required
      ...
      # @note When making an API call, pass SetPermissionRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass SetTimeBasedAutoScalingRequest
      #   data as a hash:
      #
      #       {
      #         instance_id: "String", # required
      ...
      # @note When making an API call, pass ShutdownEventConfiguration
      #   data as a hash:
      #
      #       {
      #         execution_timeout: 1,
      ...
      # @note When making an API call, pass StackConfigurationManager
      #   data as a hash:
      #
      #       {
      #         name: "String",
      ...
      # @note When making an API call, pass StartStackRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass StopStackRequest
      #   data as a hash:
      #
      #       {
      #         stack_id: "String", # required
      ...
      # @note When making an API call, pass UnassignInstanceRequest
      #   data as a hash:
      #
      #       {
      #         instance_id: "String", # required
      ...
      # @note When making an API call, pass UnassignVolumeRequest
      #   data as a hash:
      #
      #       {
      #         volume_id: "String", # required
      ...
      # @note When making an API call, pass UpdateAppRequest
      #   data as a hash:
      #
      #       {
      #         app_id: "String", # required
      ...
      # @note When making an API call, pass UpdateElasticIpRequest
      #   data as a hash:
      #
      #       {
      #         elastic_ip: "String", # required
      ...
      # @note When making an API call, pass UpdateInstanceRequest
      #   data as a hash:
      #
      #       {
      #         instance_id: "String", # required
      ...
      # @note When making an API call, pass UpdateLayerRequest
      #   data as a hash:
      #
      #       {
      #         layer_id: "String", # required
      ...
      # @note When making an API call, pass UpdateMyUserProfileRequest
      #   data as a hash:
      #
      #       {
      #         ssh_public_key: "String",
      ...
      # @note When making an API call, pass UpdateRdsDbInstanceRequest
      #   data as a hash:
      #
      #       {
      #         rds_db_instance_arn: "String", # required
      ...
      # @note When making an API call, pass UpdateUserProfileRequest
      #   data as a hash:
      #
      #       {
      #         iam_user_arn: "String", # required
      ...
      # @note When making an API call, pass UpdateVolumeRequest
      #   data as a hash:
      #
      #       {
      #         volume_id: "String", # required
      ...
      # @note When making an API call, pass VolumeConfiguration
      #   data as a hash:
      #
      #       {
      #         mount_point: "String", # required
      ...
      # @note When making an API call, pass WeeklyAutoScalingSchedule
      #   data as a hash:
      #
      #       {
      #         monday: {
