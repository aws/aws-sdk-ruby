...
Aws::Plugins::GlobalConfiguration::IDENTIFIERS << :opsworks
...
module Aws
  module OpsWorks
    class Client < Seahorse::Client::Base
      ...
      #   the named waiter.
      #
      #   * `:app_exists` => {#describe_apps}
      #   * `:deployment_successful` => {#describe_deployments}
      #   * `:instance_online` => {#describe_instances}
      #   * `:instance_registered` => {#describe_instances}
