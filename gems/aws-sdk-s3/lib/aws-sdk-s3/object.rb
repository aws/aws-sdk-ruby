...
module Aws::S3
  ...
  class Object
    ...
    # The event hold status for this object. This header is only returned if
    ...
    #  </note>
    # @return [Integer]
    def object_lock_event_hold_duration_days
      data[:object_lock_event_hold_duration_days]
    end
    ...
    #  </note>
    # @return [Integer]
    def object_lock_event_hold_duration_years
      data[:object_lock_event_hold_duration_years]
    end
