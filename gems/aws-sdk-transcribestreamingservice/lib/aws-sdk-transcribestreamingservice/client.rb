  ...
  class Client < Seahorse::Client::Base
    ...
    def start_stream_transcription(params = {}, options = {}, &block)
      ...
      event_stream_handler = case handler = params.delete(:event_stream_handler)
        when EventStreams::TranscriptResultStream then handler
        when Proc then EventStreams::TranscriptResultStream.new.tap(&handler)
        when nil then EventStreams::TranscriptResultStream.new
        else
          msg = "expected :event_stream_handler to be a block or "\
            "instance of Aws::TranscribeStreamingService::EventStreams::TranscriptResultStream"\
