...
module Aws::MigrationHubConfig
  ...
  class Client < Seahorse::Client::Base
    ...
    add_plugin(Aws::MigrationHubConfig::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::MigrationHubConfig::EndpointProvider] :endpoint_provider
    #     The endpoint provider used to resolve endpoints. Any object that responds to `#resolve_endpoint(parameters)` where `parameters` is a Struct similar to `Aws::MigrationHubConfig::EndpointParameters`
    #
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::MigrationHubConfig')
      )
