...
module Aws::RolesAnywhere
  describe EndpointProvider do
    ...
    context 'For region ap-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-south-1.api.aws"}}
      end
    ...
    context 'For region ap-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-south-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-south-1.api.aws"}}
      end
    ...
    context 'For region eu-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-south-1.api.aws"}}
      end
    ...
    context 'For region eu-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-south-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.eu-south-1.api.aws"}}
      end
    ...
    context 'For region eu-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.eu-south-1.amazonaws.com"}}
      end
    ...
    context 'For region ca-central-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ca-central-1.api.aws"}}
      end
    ...
    context 'For region ca-central-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ca-central-1.amazonaws.com"}}
      end
    ...
    context 'For region ca-central-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ca-central-1.api.aws"}}
      end
    ...
    context 'For region eu-central-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-central-1.api.aws"}}
      end
    ...
    context 'For region eu-central-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-central-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-central-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.eu-central-1.api.aws"}}
      end
    ...
    context 'For region us-west-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.us-west-1.api.aws"}}
      end
    ...
    context 'For region us-west-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.us-west-1.amazonaws.com"}}
      end
    ...
    context 'For region us-west-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.us-west-1.api.aws"}}
      end
    ...
    context 'For region us-west-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.us-west-2.api.aws"}}
      end
    ...
    context 'For region us-west-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.us-west-2.amazonaws.com"}}
      end
    ...
    context 'For region us-west-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.us-west-2.api.aws"}}
      end
    ...
    context 'For region af-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.af-south-1.api.aws"}}
      end
    ...
    context 'For region af-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.af-south-1.amazonaws.com"}}
      end
    ...
    context 'For region af-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.af-south-1.api.aws"}}
      end
    ...
    context 'For region af-south-1 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.af-south-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-north-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-north-1.api.aws"}}
      end
    ...
    context 'For region eu-north-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-north-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-north-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.eu-north-1.api.aws"}}
      end
    ...
    context 'For region eu-west-3 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-west-3.api.aws"}}
      end
    ...
    context 'For region eu-west-3 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-west-3.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-3 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.eu-west-3.api.aws"}}
      end
    ...
    context 'For region eu-west-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-west-2.api.aws"}}
      end
    ...
    context 'For region eu-west-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-west-2.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.eu-west-2.api.aws"}}
      end
    ...
    context 'For region eu-west-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-west-1.api.aws"}}
      end
    ...
    context 'For region eu-west-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.eu-west-1.amazonaws.com"}}
      end
    ...
    context 'For region eu-west-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.eu-west-1.api.aws"}}
      end
    ...
    context 'For region ap-northeast-3 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-northeast-3.api.aws"}}
      end
    ...
    context 'For region ap-northeast-3 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-northeast-3.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-3 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-northeast-3.api.aws"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-northeast-2.api.aws"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-northeast-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-northeast-2.api.aws"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-northeast-1.api.aws"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-northeast-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-northeast-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-northeast-1.api.aws"}}
      end
    ...
    context 'For region me-south-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.me-south-1.api.aws"}}
      end
    ...
    context 'For region me-south-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.me-south-1.amazonaws.com"}}
      end
    ...
    context 'For region me-south-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.me-south-1.api.aws"}}
      end
    ...
    context 'For region sa-east-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.sa-east-1.api.aws"}}
      end
    ...
    context 'For region sa-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.sa-east-1.amazonaws.com"}}
      end
    ...
    context 'For region sa-east-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.sa-east-1.api.aws"}}
      end
    ...
    context 'For region ap-east-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-east-1.api.aws"}}
      end
    ...
    context 'For region ap-east-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-east-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-east-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-east-1.api.aws"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-southeast-1.api.aws"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-southeast-1.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-1 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-southeast-1.api.aws"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-southeast-2.api.aws"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-southeast-2.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-southeast-2.api.aws"}}
      end
    ...
    context 'For region ap-southeast-3 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-southeast-3.api.aws"}}
      end
    ...
    context 'For region ap-southeast-3 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.ap-southeast-3.amazonaws.com"}}
      end
    ...
    context 'For region ap-southeast-3 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-southeast-3.api.aws"}}
      end
    ...
    context 'For region ap-southeast-3 with FIPS disabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.ap-southeast-3.amazonaws.com"}}
      end
    ...
    context 'For region us-east-2 with FIPS enabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.us-east-2.api.aws"}}
      end
    ...
    context 'For region us-east-2 with FIPS enabled and DualStack disabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere-fips.us-east-2.amazonaws.com"}}
      end
    ...
    context 'For region us-east-2 with FIPS disabled and DualStack enabled' do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://rolesanywhere.us-east-2.api.aws"}}
      end
