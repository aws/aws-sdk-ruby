...
module Aws::ConnectContactLens
  ...
  class Client < Seahorse::Client::Base
    ...
    #     sending the request.
    #
    #   @option options [Aws::ConnectContactLens::EndpointProvider] :endpoint_provider
    #     The endpoint provider used to resolve endpoints. Any object that responds to `#resolve_endpoint(parameters)` where `parameters` is a Struct similar to `Aws::ConnectContactLens::EndpointParameters`
    #
