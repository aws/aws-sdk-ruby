...
module Aws::Route53Domains
  describe EndpointProvider do
    subject { Aws::Route53Domains::EndpointProvider.new }

    context "For region us-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains-fips.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains-fips.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains.us-east-1.api.aws"}}
      end
    ...
    context "For region cn-north-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains-fips.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains-fips.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains-fips.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains-fips.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://route53domains.us-isob-east-1.sc2s.sgov.gov"}}
      end
