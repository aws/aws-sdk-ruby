...
module Aws::BCMPricingCalculator
  describe EndpointProvider do
    subject { Aws::BCMPricingCalculator::EndpointProvider.new }
    ...
    context "For region us-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-east-1"}]}, "url" => "https://bcm-pricing-calculator-fips.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-east-1"}]}, "url" => "https://bcm-pricing-calculator.us-east-1.api.aws"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "cn-northwest-1"}]}, "url" => "https://bcm-pricing-calculator-fips.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "cn-northwest-1"}]}, "url" => "https://bcm-pricing-calculator.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-gov-west-1"}]}, "url" => "https://bcm-pricing-calculator-fips.us-gov-west-1.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-gov-west-1"}]}, "url" => "https://bcm-pricing-calculator.us-gov-west-1.api.aws"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-iso-east-1"}]}, "url" => "https://bcm-pricing-calculator-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-iso-east-1"}]}, "url" => "https://bcm-pricing-calculator.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-isob-east-1"}]}, "url" => "https://bcm-pricing-calculator-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-isob-east-1"}]}, "url" => "https://bcm-pricing-calculator.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region eu-isoe-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "eu-isoe-west-1"}]}, "url" => "https://bcm-pricing-calculator-fips.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context "For region eu-isoe-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "eu-isoe-west-1"}]}, "url" => "https://bcm-pricing-calculator.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context "For region us-isof-south-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-isof-south-1"}]}, "url" => "https://bcm-pricing-calculator-fips.us-isof-south-1.csp.hci.ic.gov"}}
      end
    ...
    context "For region us-isof-south-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "us-isof-south-1"}]}, "url" => "https://bcm-pricing-calculator.us-isof-south-1.csp.hci.ic.gov"}}
      end
