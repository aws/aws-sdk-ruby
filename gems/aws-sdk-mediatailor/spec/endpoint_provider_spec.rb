...
module Aws::MediaTailor
  describe EndpointProvider do
    ...
    context "For region cn-northwest-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor-fips.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor-fips.cn-northwest-1.amazonaws.com.cn"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor.cn-northwest-1.amazonaws.com.cn"}}
      end
    ...
    context "For region eusc-de-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor-fips.eusc-de-east-1.amazonaws.eu"}}
      end
    ...
    context "For region eusc-de-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor.eusc-de-east-1.amazonaws.eu"}}
      end
    ...
    context "For region eu-isoe-west-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor-fips.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context "For region eu-isoe-west-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context "For region us-isof-south-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor-fips.us-isof-south-1.csp.hci.ic.gov"}}
      end
    ...
    context "For region us-isof-south-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor.us-isof-south-1.csp.hci.ic.gov"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor-fips.us-gov-west-1.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor-fips.us-gov-west-1.amazonaws.com"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor.us-gov-west-1.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://api.mediatailor.us-gov-west-1.amazonaws.com"}}
      end
