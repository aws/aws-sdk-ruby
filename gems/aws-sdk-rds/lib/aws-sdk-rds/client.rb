...
Aws::Plugins::GlobalConfiguration::IDENTIFIERS << :rds
...
module Aws
  module RDS
    class Client < Seahorse::Client::Base
      ...
      #
      # <note markdown="1"> You cannot authorize ingress from an EC2 security group in one region
      ...
      #   the named waiter.
      #
      #   * `:db_instance_available` => {#describe_db_instances}
      #   * `:db_instance_deleted` => {#describe_db_instances}
      #
