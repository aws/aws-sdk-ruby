...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-agentregistry'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Agent Registry'
  spec.description   = 'Official AWS Ruby gem for Agent Registry. This gem is part of the AWS SDK for Ruby.'
