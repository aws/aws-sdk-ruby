...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-elementalinference'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Elemental Inference'
  spec.description   = 'Official AWS Ruby gem for AWS Elemental Inference. This gem is part of the AWS SDK for Ruby.'
