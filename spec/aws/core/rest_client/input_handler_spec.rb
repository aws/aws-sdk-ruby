  ...
  module Core
    module RESTClient
      describe InputHandler do
        ...
        let(:handler) { InputHandler.new(namespace, operation) }
        ...
        context '#namespace' do
          ...
          it 'returns the api version' do
            handler.namespace.should == namespace
          end
        ...
        context '#operation_name' do
          ...
          it 'returns the operation name from the operation description' do
            handler.operation_name.should == 'OperationName'
          end
        ...
        context '#http' do
          ...
          it 'returns the http description from the operation description' do
            handler.http.should == operation[:http]
          end
